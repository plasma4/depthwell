(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))r(e);new MutationObserver(e=>{for(const s of e)if(s.type==="childList")for(const o of s.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&r(o)}).observe(document,{childList:!0,subtree:!0});function n(e){const s={};return e.integrity&&(s.integrity=e.integrity),e.referrerPolicy&&(s.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?s.credentials="include":e.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function r(e){if(e.ep)return;e.ep=!0;const s=n(e);fetch(e.href,s)}})();const a={zoom:131072,mine:262144,drop:524288,minus:32768,plus:65536,up:2048,left:4096,down:8192,right:16384,k0:1,k1:2,k2:4,k3:8,k4:16,k5:32,k6:64,k7:128,k8:256,k9:512},R={player_pos:0,last_player_pos:16,player_chunk:32,player_velocity:48,camera_pos:64,last_camera_pos:80,camera_scale:96,camera_scale_change:104,depth:112,player_quadrant:120,frame:124,keys_pressed_mask:128,keys_held_mask:132,seed:144,seed2:208},V="abcdefghijklmnopqrstuvwxyz",y=26n;function q(i=100){if(i<=0)return"";const t=new Uint8Array(72);crypto.getRandomValues(t);let n=0n;const r=new DataView(t.buffer);for(let o=0;o<t.length;o+=8)n=n<<64n|r.getBigUint64(o);let e="",s=n%y**BigInt(i);for(;s>=0n&&(e+=V[Number(s%y)],s=s/y-1n,!(s<0n)););return e}function H(i){let t=0n;for(let n=0;n<i.length;n++){const r=BigInt(i.charCodeAt(n)-97);t=t*y+(r+1n)}return t}async function W(i,t){const n=H(i),r=new DataView(new ArrayBuffer(64));for(let l=0;l<8;l++)r.setBigUint64(l*8,n>>BigInt((7-l)*64)&0xffffffffffffffffn);let e=new Uint8Array(r.buffer,0,32),s=new Uint8Array(r.buffer,32,32);const o=await Promise.all([0,1,2,3].map(l=>crypto.subtle.importKey("raw",new Uint8Array([l]),{name:"HMAC",hash:"SHA-256"},!1,["sign"])));for(const l of o){const f=new Uint8Array(await crypto.subtle.sign("HMAC",l,s)),p=new Uint8Array(32);for(let _=0;_<32;_++)p[_]=e[_]^f[_];e=s,s=p}const u=new Uint8Array(64);return u.set(e,0),u.set(s,32),t.set(new BigUint64Array(u.buffer)),t}const k={Minus:a.minus,Equal:a.plus,KeyZ:a.zoom,Backquote:a.mine,KeyQ:a.drop,Space:a.up,ArrowUp:a.up,KeyW:a.up,ArrowLeft:a.left,KeyA:a.left,ArrowDown:a.down,KeyS:a.down,ArrowRight:a.right,KeyD:a.right,Digit0:a.k0,Digit1:a.k1,Digit2:a.k2,Digit3:a.k3,Digit4:a.k4,Digit5:a.k5,Digit6:a.k6,Digit7:a.k7,Digit8:a.k8,Digit9:a.k9},B=a.up|a.down|a.left|a.right;function K(){let i={};const t={heldMask:0,keysHeld:0,keysPressed:0,currentlyHeld:0,horizontalPriority:0,verticalPriority:0,plusMinusPriority:0};function n(){i={},t.horizontalPriority=0,t.verticalPriority=0,t.plusMinusPriority=0,t.currentlyHeld=0,t.heldMask=0,t.keysPressed=0}return window.addEventListener("keydown",r=>{if(r.repeat)return;if(r.ctrlKey||r.metaKey){n();return}const e=k[r.code];e&&(e<=512&&(t.heldMask=t.heldMask&4294966272),t.heldMask|=e,e&B&&(i[e]=(i[e]||0)+1),e&(a.left|a.right)&&(t.horizontalPriority=e),e&(a.up|a.down)&&(t.verticalPriority=e),e&(a.plus|a.minus)&&(t.plusMinusPriority=e))}),window.addEventListener("keyup",r=>{const e=k[r.code];e&&(e&B?(i[e]=Math.max(0,(i[e]||0)-1),i[e]===0&&(t.heldMask&=~e)):t.heldMask&=~e,t.heldMask&e||(e===t.horizontalPriority&&(t.horizontalPriority=t.heldMask&a.left||t.heldMask&a.right||0),e===t.verticalPriority&&(t.verticalPriority=t.heldMask&a.up||t.heldMask&a.down||0),e===t.plusMinusPriority&&(t.plusMinusPriority=t.heldMask&a.plus||t.heldMask&a.minus||0)))}),window.addEventListener("blur",n),document.addEventListener("visibilitychange",n),window.addEventListener("contextmenu",n),t}function X(i){const t=a.up|a.down|a.left|a.right;let n=i.heldMask&~t;n|=i.horizontalPriority,n|=i.verticalPriority,n|=i.plusMinusPriority,i.keysPressed=n&~i.keysHeld,i.currentlyHeld=n,i.keysHeld=n}const Z=""+new URL("main-BmcBJwMG.wasm",import.meta.url).href,Y=`/*
...
fn oklch_to_oklab(lch: vec3f) -> vec3f {
    ...
    <div id="debugContainer"></div>`;document.addEventListener("wheel",function(i){i.ctrlKey},{passive:!1});let c=await T.create();c.getTimeoutLength=function(){return++ee%3==2?16:17};c.getFrameRate=function(){return 60};c.baseSpeed=1;let v=performance.now(),b=0,ee=0;globalThis.engine=c;console.log("Engine initialized successfully:",c),console.log("Exported functions and memory:",c.exports);window.addEventListener("blur",()=>v=1/0);const w=Array(60).fill(0),S=Array(60).fill(0),A=Array(60).fill(0);c.isDebug=!!c.exports.isDebug();c.renderLoop=function(i){let t=performance.now(),n=v===1/0?0:t-v,r=Math.min(n*c.getFrameRate()/1e3,c.getFrameRate());c.logicLoop(Math.max(Math.floor(b+r),1)),b=(b+r)%1;{S.shift(),S.push(n),A.shift(),A.push(c.prepare_visible_data_time);const s=Math.max.apply(null,S),o=Math.max.apply(null,A);let u="#cccccc";s>55?u="#e83769":s>30?u="#f39c19":s>20&&(u="#f7ce1a");const l=document.getElementById("renderText");l.textContent=`Time since last render/prepare_visible_data time: ${n.toFixed(1)}ms, ${c.prepare_visible_data_time.toFixed(1)}ms
Worst (past 60 frames): ${s.toFixed(1)}ms, ${o.toFixed(1)}ms`,l.style.fontWeight=s>40?s>55?700:600:500,l.style.color=u}let e=Math.min(b-1,0);c.renderFrame(e,v),requestAnimationFrame(c.renderLoop)};c.logicLoop=function(i){const t=performance.now();c.tick(60/c.getFrameRate()*c.baseSpeed,i),v=performance.now();let n=v-t;{w.shift(),w.push(n);const r=Math.max.apply(null,w);let e="#cccccc";r>30?e="#e83769":r>15?e="#f39c19":r>10&&(e="#f7ce1a");const s=document.getElementById("logicText");s.textContent=`Logic diff: ${n.toFixed(1)}ms for ${i} tick${i==1?"":"s"}
Worst (past 60 frames): ${r.toFixed(1)}ms
`,s.style.fontWeight=r>20?r>40?700:600:500,s.style.color=e}};const P=(i,t)=>{const n=c.canvas.getBoundingClientRect(),r=(i.clientX-n.left)/n.width,e=(i.clientY-n.top)/n.height;r>=0&&r<=1&&e>=0&&e<=1&&c.exports.handle_mouse(r,e,t)};document.addEventListener("pointermove",i=>{i.buttons>0&&P(i,0)});document.addEventListener("pointerdown",i=>{if(!i.target||i.target.id==="debugContainer")return;const t=i.button===2?3:1;P(i,t)});document.addEventListener("pointerup",i=>{const t=i.button===2?4:2;P(i,t)});c.canvas.style.touchAction="none";document.addEventListener("contextmenu",i=>i.preventDefault());{const i=c.exports;i.debug_build_ui_metadata();const t=c.readStr(),n=JSON.parse(t),r=document.getElementById("debugContainer");n.buttons.forEach(e=>{const s=document.createElement("button");s.textContent=e.name,s.onclick=()=>i.debug_ui_button_click(e.id),r.appendChild(s)}),n.sliders.forEach(e=>{const s=document.createElement("div");s.style.display="flex",s.style.flexDirection="column";const o=document.createElement("label");o.textContent=`${e.name}: ${e.val.toFixed(2)}`,o.style.fontSize="12px";const u=document.createElement("input");u.type="range",u.min=e.min,u.max=e.max,u.step=((e.max-e.min)/1e3).toString(),u.value=e.val,u.oninput=l=>{const f=parseFloat(l.target.value);o.textContent=`${e.name}: ${f.toFixed(2)}`,i.debug_ui_slider_change(e.id,f)},s.appendChild(o),s.appendChild(u),r.appendChild(s)}),document.body.appendChild(r)}setTimeout(function(){c.renderLoop(0)},17);

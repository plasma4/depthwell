...
fn fs_tile(in: TileOutput) -> @location(0) vec4f {
    ...
    if is_gem || is_ore {
        ...
        let final_rgb_ore = mix(
            srgb_to_linear(tex_stone.rgb) * vec3f(1.2 - 1.6 * u_dist), 

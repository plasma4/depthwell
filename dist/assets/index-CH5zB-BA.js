(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))r(t);new MutationObserver(t=>{for(const s of t)if(s.type==="childList")for(const o of s.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&r(o)}).observe(document,{childList:!0,subtree:!0});function n(t){const s={};return t.integrity&&(s.integrity=t.integrity),t.referrerPolicy&&(s.referrerPolicy=t.referrerPolicy),t.crossOrigin==="use-credentials"?s.credentials="include":t.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function r(t){if(t.ep)return;t.ep=!0;const s=n(t);fetch(t.href,s)}})();const a={zoom:131072,drop:262144,minus:32768,plus:65536,up:2048,left:4096,down:8192,right:16384,k0:1,k1:2,k2:4,k3:8,k4:16,k5:32,k6:64,k7:128,k8:256,k9:512},E={player_pos:0,last_player_pos:16,player_chunk:32,player_velocity:48,camera_pos:64,last_camera_pos:80,camera_scale:96,camera_scale_change:104,depth:112,player_quadrant:120,frame:124,keys_pressed_mask:128,keys_held_mask:132,seed:144,seed2:208},U="abcdefghijklmnopqrstuvwxyz",b=26n;function M(i=100){if(i<=0)return"";const e=new Uint8Array(72);crypto.getRandomValues(e);let n=0n;const r=new DataView(e.buffer);for(let o=0;o<e.length;o+=8)n=n<<64n|r.getBigUint64(o);let t="",s=n%b**BigInt(i);for(;s>=0n&&(t+=U[Number(s%b)],s=s/b-1n,!(s<0n)););return t}function z(i){let e=0n;for(let n=0;n<i.length;n++){const r=BigInt(i.charCodeAt(n)-97);e=e*b+(r+1n)}return e}async function N(i,e){const n=z(i),r=new DataView(new ArrayBuffer(64));for(let l=0;l<8;l++)r.setBigUint64(l*8,n>>BigInt((7-l)*64)&0xffffffffffffffffn);let t=new Uint8Array(r.buffer,0,32),s=new Uint8Array(r.buffer,32,32);const o=await Promise.all([0,1,2,3].map(l=>crypto.subtle.importKey("raw",new Uint8Array([l]),{name:"HMAC",hash:"SHA-256"},!1,["sign"])));for(const l of o){const _=new Uint8Array(await crypto.subtle.sign("HMAC",l,s)),p=new Uint8Array(32);for(let f=0;f<32;f++)p[f]=t[f]^_[f];t=s,s=p}const d=new Uint8Array(64);return d.set(t,0),d.set(s,32),e.set(new BigUint64Array(d.buffer)),e}const S={Minus:a.minus,Equal:a.plus,KeyZ:a.zoom,KeyQ:a.drop,Space:a.up,ArrowUp:a.up,KeyW:a.up,ArrowLeft:a.left,KeyA:a.left,ArrowDown:a.down,KeyS:a.down,ArrowRight:a.right,KeyD:a.right,Digit0:a.k0,Digit1:a.k1,Digit2:a.k2,Digit3:a.k3,Digit4:a.k4,Digit5:a.k5,Digit6:a.k6,Digit7:a.k7,Digit8:a.k8,Digit9:a.k9};function F(){let i={};const e={heldMask:0,keysHeld:0,keysPressed:0,currentlyHeld:0,horizontalPriority:0,verticalPriority:0,plusMinusPriority:0};function n(){i={},e.horizontalPriority=0,e.verticalPriority=0,e.plusMinusPriority=0,e.currentlyHeld=0,e.heldMask=0,e.keysPressed=0}return window.addEventListener("keydown",r=>{if(r.repeat||r.altKey||r.ctrlKey||r.metaKey||r.shiftKey)return;const t=S[r.code];t&&(e.heldMask|=t,i[t]=(i[t]||0)+1,t&(a.left|a.right)&&(e.horizontalPriority=t),t&(a.up|a.down)&&(e.verticalPriority=t),t&(a.plus|a.minus)&&(e.plusMinusPriority=t))}),window.addEventListener("keyup",r=>{const t=S[r.code];t&&(i[t]=Math.max(0,(i[t]||0)-1),i[t]===0&&(e.heldMask&=~t,t===e.horizontalPriority&&(e.horizontalPriority=e.heldMask&a.left||e.heldMask&a.right||0),t===e.verticalPriority&&(e.verticalPriority=e.heldMask&a.up||e.heldMask&a.down||0),t===e.plusMinusPriority&&(e.plusMinusPriority=e.heldMask&a.plus||e.heldMask&a.minus||0)))}),window.addEventListener("blur",n),document.addEventListener("visibilitychange",n),window.addEventListener("contextmenu",n),e}function V(i){const e=a.up|a.down|a.left|a.right;let n=i.heldMask&~e;n|=i.horizontalPriority,n|=i.verticalPriority,n|=i.plusMinusPriority,i.keysPressed=n&~i.keysHeld,i.currentlyHeld=n,i.keysHeld=n}const q=""+new URL("main-D___9jN_.wasm",import.meta.url).href,H=`/*
...
`,C=""+new URL("main-DswnQvn1.png",import.meta.url).href;async function K(i,e){const n=await navigator.gpu.requestAdapter({powerPreference:e&&e.highPerformance?"high-performance":"low-power"});if(!n)throw new DOMException("Couldn't request WebGPU adapter.","NotSupportedError");const r=await n.requestDevice();let t=null;if(r.addEventListener("uncapturederror",u=>{const g=u.error;if(t===null)if(globalThis.reportError)reportError(g);else throw g;else if(!t.destroyed){t.destroy("fatal WebGPU error",g);return}}),r.lost.then(u=>console.error(`WebGPU Device lost: ${u.message}`)),i===void 0){if(i=document.getElementsByTagName("canvas")[0],i===void 0)throw Error("No canvas element or ID string provided, and no canvas was not found in the HTML.")}else if(typeof i=="string"){const u=document.getElementById(i);if(!(u instanceof HTMLCanvasElement))throw Error(`Element with ID "${i}" is not a canvas element.`);i=u}const s=i.getContext("webgpu");if(!s)throw Error("Could not get WebGPU context from canvas.");const o=r.features.has("canvas-rgba16float-support")?"rgba16float":"bgra8unorm";s.configure({device:r,format:o,alphaMode:"opaque"});const d=await WebAssembly.instantiateStreaming(fetch(q),{env:{js_message:(u,g,y)=>{let h=new TextDecoder().decode(new Uint8Array(_.buffer,Number(u),Number(g)));h.charAt(0)!=="]"?h="["+(t?.LOGGING_PREFIX||"")+h:h=h.slice(1),y===1?console.info("%c"+h,"font-weight: 600"):[console.log,console.info,console.warn,console.error][y](h)},js_write_text:(u,g,y)=>{const h=new Uint8Array(_.buffer,Number(g),Number(y)),L=new TextDecoder().decode(h),G=document.getElementById(`text${u+1}`);G.textContent=L},js_get_time:()=>performance.now(),js_handle_visible_chunks:u=>t?.handleVisibleChunks(u)}}),l=d.instance.exports,_=l.memory,p=r.createShaderModule({label:"Main shader",code:H.replace("/* TILES_PER_ROW */ 1 /* TILES_PER_ROW */",""+l.get_tiles_per_row()).replace("/* TILES_PER_COLUMN */ 1 /* TILES_PER_COLUMN */",""+l.get_tiles_per_column()).replace("/* STONE_START */ 1 /* STONE_START */",""+l.get_stone_start()).replace("/* GEM_START */ 1 /* GEM_START */",""+l.get_ore_start()).replace("/* GEM_MASK_START */ 1 /* GEM_MASK_START */",""+l.get_gem_mask_start()).replace("/* DECOR_START */ 1 /* DECOR_START */",""+l.get_decor_start())}),f=r.createBindGroupLayout({label:"Main bind group layout",entries:[{binding:0,visibility:GPUShaderStage.VERTEX|GPUShaderStage.FRAGMENT,buffer:{type:"uniform",hasDynamicOffset:!0}},{binding:1,visibility:GPUShaderStage.VERTEX|GPUShaderStage.FRAGMENT,buffer:{type:"read-only-storage"}},{binding:2,visibility:GPUShaderStage.FRAGMENT,texture:{}},{binding:3,visibility:GPUShaderStage.FRAGMENT,sampler:{}}]}),m=r.createPipelineLayout({label:"Shared Pipeline Layout",bindGroupLayouts:[f]}),P=r.createRenderPipeline({label:"Tilemap pipeline",layout:m,vertex:{module:p,entryPoint:"vs_main"},fragment:{module:p,entryPoint:"fs_main",targets:[{format:o,blend:{color:{srcFactor:"src-alpha",dstFactor:"one-minus-src-alpha"},alpha:{srcFactor:"one",dstFactor:"one-minus-src-alpha"}}}]},primitive:{topology:"triangle-list",cullMode:"none"}}),I=r.createRenderPipeline({label:"Background pipeline",layout:m,vertex:{module:p,entryPoint:"vs_background"},fragment:{module:p,entryPoint:"fs_background",targets:[{format:o}]},primitive:{topology:"triangle-list"}});t=new T(i,n,r,s,d,P,I),t.exports.setup(),await t.setSeed(M(100)),t.startDelta=Number(l.mix_seed(60n)%120000n),t.exports.init();const A=new ResizeObserver(t.onResize);t.resizeObserver=A,t.updateCanvasStyle();try{t.resizeObserver.observe(i,{box:"device-pixel-content-box"})}catch{console.log("ResizeObserver property device-pixel-content-box not supported, falling back to content-box."),t.resizeObserver.observe(i,{box:"content-box"})}t.onResize([{contentRect:{width:i.clientWidth,height:i.clientHeight}}]);const B=await T.loadTexture(r,C),D=r.createSampler({magFilter:"nearest",minFilter:"nearest",addressModeU:"clamp-to-edge",addressModeV:"clamp-to-edge"});t.atlasTextureView=B.createView(),t.pixelSampler=D;const O=r.createBuffer({label:"SceneUniforms",size:256*w,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST});return t.uniformBuffer=O,t}var k=(i=>(i[i.Uint8=8]="Uint8",i[i.Uint16=16]="Uint16",i[i.Uint32=32]="Uint32",i[i.Uint64=64]="Uint64",i[i.Int8=-8]="Int8",i[i.Int16=-16]="Int16",i[i.Int32=-32]="Int32",i[i.Int64=-64]="Int64",i[i.Uint8Clamped=-80]="Uint8Clamped",i[i.Float32=-320]="Float32",i[i.Float64=-640]="Float64",i))(k||{});globalThis.WasmTypeCode=k;const R={8:Uint8Array,16:Uint16Array,32:Uint32Array,64:BigUint64Array,[-8]:Int8Array,[-16]:Int16Array,[-32]:Int32Array,[-64]:BigInt64Array,[-80]:Uint8ClampedArray,[-320]:Float32Array,[-640]:Float64Array},w=4;class T{engineModule;exports;memory;LAYOUT_PTR;GAME_STATE_PTR;canvas;adapter;device;context;bindGroups=Array(w);uniformBuffer;tileBuffers=Array(w);tileBufferDirty=!1;atlasTextureView;pixelSampler;renderPipeline;bgPipeline;renderPass=null;currentEncoder=null;currentTextureView=null;renderCallId=0;sceneDataBuffer=new ArrayBuffer(256);sceneDataF32=new Float32Array(this.sceneDataBuffer);sceneDataU32=new Uint32Array(this.sceneDataBuffer);inputState;resizeObserver;forceAspectRatio=!0;previousForceAspectRatio=null;tileMapWidth;tileMapHeight;prepare_visible_chunks_time=0;isVisibleDataNew=!0;wireframeOpacity=0;startTime=performance.now();startDelta;seed="";destroyed=!1;destroyedError=null;encoder=new TextEncoder;decoder=new TextDecoder;LOGGING_PREFIX="";constructor(e,n,r,t,s,o,d){this.canvas=e,this.adapter=n,this.device=r,this.context=t,this.engineModule=s,this.renderPipeline=o,this.bgPipeline=d,this.exports=s.instance.exports,this.memory=s.instance.exports.memory,this.LAYOUT_PTR=Number(this.exports.get_memory_layout_ptr()),this.GAME_STATE_PTR=Number(this.getScratchView()[3]),this.inputState=F()}static async create(e,n){return await K(e,n)}destroy(e="unknown reason",n=null){this.resizeObserver.disconnect(),this.destroyed=e,this.destroyedError=n}static async loadTexture(e,n){const t=await(await fetch(n)).blob(),s=await createImageBitmap(t),o=e.createTexture({label:`Texture from  ${n}`,size:[s.width,s.height],format:e.features.has("canvas-rgba16float-support")?"rgba16float":"bgra8unorm",usage:GPUTextureUsage.TEXTURE_BINDING|GPUTextureUsage.COPY_DST|GPUTextureUsage.RENDER_ATTACHMENT});return e.queue.copyExternalImageToTexture({source:s},{texture:o},[s.width,s.height]),o}uploadVisibleChunks(e=1){const n=performance.now();this.exports.prepare_visible_chunks(e,this.canvas.width,this.canvas.height),this.prepare_visible_chunks_time=performance.now()-n}handleVisibleChunks(e){if(!this.currentEncoder||!this.currentTextureView||!this.renderPass)return;const n=this.getScratchPtr();if(this.getScratchLen()===0)return;const t=Number(this.getScratchProperty(0)),s=Number(this.getScratchProperty(1)),o=t*s*2;this.tileMapWidth=t,this.tileMapHeight=s;const d=new Uint32Array(this.memory.buffer,n,o),l=o*4;this.recreateBufferAndBindGroup(l),this.renderPass.setPipeline(this.renderPipeline),this.renderPass.setBindGroup(0,this.bindGroups[this.renderCallId],[this.renderCallId*256]),this.renderPass.setViewport(0,0,this.canvas.width,this.canvas.height,0,1),this.setSceneData(e,t,s),this.device.queue.writeBuffer(this.tileBuffers[this.renderCallId],0,d);const _=t*s+1;this.renderPass.draw(6,_),this.renderCallId++}setSceneData(e,n,r){const t=this.getScratchProperty(2,-640),s=this.getScratchProperty(3,-640),o=this.getScratchProperty(4,-640),d=this.getScratchProperty(5,-640),l=this.getScratchProperty(6,-640);this.sceneDataF32[0]=t,this.sceneDataF32[1]=s,this.sceneDataF32[2]=this.canvas.width,this.sceneDataF32[3]=this.canvas.height;const _=6e4,f=(performance.now()-this.startTime+this.startDelta)%(_*2);let m;f<_?m=f/1e3:m=(_-(f-_))/1e3,this.sceneDataF32[4]=m,this.sceneDataF32[5]=o,this.sceneDataF32[6]=o<.25?0:this.wireframeOpacity,this.sceneDataF32[7]=e,this.sceneDataF32[8]=d,this.sceneDataF32[9]=l,this.sceneDataU32[10]=n,this.sceneDataU32[11]=r,this.device.queue.writeBuffer(this.uniformBuffer,this.renderCallId*256,this.sceneDataF32)}recreateBufferAndBindGroup(e){const n=this.renderCallId;(!this.tileBuffers[n]||this.tileBuffers[n].size<e)&&(this.tileBuffers[n]=this.device.createBuffer({label:`Tile grid slot ${n}`,size:e,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST}),this.bindGroups[n]=this.device.createBindGroup({label:`Bind group slot ${n}`,layout:this.renderPipeline.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:this.uniformBuffer,offset:0,size:256}},{binding:1,resource:{buffer:this.tileBuffers[n]}},{binding:2,resource:this.atlasTextureView},{binding:3,resource:this.pixelSampler}]}))}getWASMMemoryMB(){return this.memory.buffer.byteLength/1024/1024}getGameView(e,n=0,r){return new R[e](this.memory.buffer,this.GAME_STATE_PTR+n,r)}getRawView(e,n,r){return new R[e](this.memory.buffer,n,r)}_tempScratchViewU64=null;_tempScratchViewF64=null;getScratchView(){return(this._tempScratchViewU64===null||this._tempScratchViewU64.buffer!==this.memory.buffer)&&(this._tempScratchViewU64=new BigUint64Array(this.memory.buffer,this.LAYOUT_PTR,24)),this._tempScratchViewU64}getScratchPtr(){return Number(this.getScratchView()[0])}getScratchLen(){return Number(this.getScratchView()[1])}setScratchLen(e){this.getScratchView()[1]=BigInt(e)}getScratchCapacity(){return Number(this.getScratchView()[2])}getScratchProperty(e,n=64){(this._tempScratchViewU64===null||this._tempScratchViewU64.buffer!==this.memory.buffer)&&(this._tempScratchViewU64=new BigUint64Array(this.memory.buffer,this.LAYOUT_PTR,24));let r=this._tempScratchViewU64;return n==-640&&((this._tempScratchViewF64===null||this._tempScratchViewF64.buffer!==this.memory.buffer)&&(this._tempScratchViewF64=new Float64Array(r.buffer,r.byteOffset,r.length)),r=this._tempScratchViewF64),Number(r[e+4])}readStr(e=this.getScratchPtr(),n=this.getScratchLen()){const r=new Uint8Array(this.memory.buffer,e,n);return this.decoder.decode(r)}writeStr(e,n=!0){const r=e.length;if(r===0)return null;n&&this.setScratchLen(0);const t=this.exports.scratch_alloc(r);if(t===0n)return null;const s=new Uint8Array(this.memory.buffer,Number(t),r);if(this.encoder.encodeInto(e,s).read<r)throw new RangeError("String truncated with non-ASCII characters detected.");return Number(t)}async setSeed(e){this.seed=e,await N(e,this.getGameView(64,E.seed,8))}updateCanvasStyle(){this.forceAspectRatio!==this.previousForceAspectRatio&&(this.previousForceAspectRatio=this.forceAspectRatio,this.forceAspectRatio?(this.canvas.style.maxWidth=`calc(100vh*${16/9})`,this.canvas.style.maxHeight=`calc(100vw*${9/16})`):(this.canvas.style.maxWidth="none",this.canvas.style.maxHeight="none"))}onResize=e=>{const n=e[0];let r,t;if(n.devicePixelContentBoxSize)r=n.devicePixelContentBoxSize[0].inlineSize,t=n.devicePixelContentBoxSize[0].blockSize;else if(n.contentBoxSize){const s=n.contentBoxSize[0].inlineSize,o=n.contentBoxSize[0].blockSize;r=Math.round(s*devicePixelRatio),t=Math.round(o*devicePixelRatio)}else{const s=n.contentRect.width,o=n.contentRect.height;r=Math.round(s*devicePixelRatio),t=Math.round(o*devicePixelRatio)}(this.canvas.width!==r||this.canvas.height!==t)&&(this.canvas.width=r,this.canvas.height=t)};renderFrame(e,n){if(this.renderCallId=0,this.destroyed!==!1)return;this.updateCanvasStyle(),this.currentEncoder=this.device.createCommandEncoder(),this.currentTextureView=this.context.getCurrentTexture().createView();const r=this.currentEncoder.beginRenderPass({colorAttachments:[{view:this.currentTextureView,loadOp:"clear",clearValue:{r:0,g:0,b:0,a:1},storeOp:"store"}]});this.renderPass=r,this.recreateBufferAndBindGroup(1024),this.sceneDataF32[7]=1,this.device.queue.writeBuffer(this.uniformBuffer,this.renderCallId*256,this.sceneDataF32),this.renderPass.setPipeline(this.bgPipeline),this.renderPass.setBindGroup(0,this.bindGroups[this.renderCallId],[this.renderCallId++*256]),this.renderPass.draw(3),this.uploadVisibleChunks(e),this.renderPass.end(),this.device.queue.submit([this.currentEncoder.finish()]),this.currentEncoder=null,this.currentTextureView=null}tick(e,n){const r=this.getGameView(32,E.keys_pressed_mask,2);V(this.inputState),r[0]=this.inputState.keysPressed,r[1]=this.inputState.keysHeld,this.exports.tick(e,n)}}location.protocol==="file:"&&alert("This game cannot run from a local file:// context; use an online version or test from localhost instead.");isSecureContext||alert("This game cannot run in a non-secure context.");navigator.gpu||alert("WebGPU is not supported by your browser; try playing this on an alternate or more modern browser.");const W=await navigator.gpu.requestAdapter();W||alert("WebGPU is supported, but no compatible GPU was found.");document.addEventListener("wheel",function(i){i.ctrlKey},{passive:!1});let c=await T.create();c.getTimeoutLength=function(){return++Z%3==2?16:17};c.getFrameRate=function(){return 60};c.baseSpeed=1;let x=performance.now(),v=0,Z=0;globalThis.engine=c;console.log("Engine initialized successfully:",c),console.log("Exported functions and memory:",c.exports);window.addEventListener("blur",()=>x=1/0);Array(60).fill(0);Array(60).fill(0);Array(60).fill(0);c.isDebug=!!c.exports.isDebug();c.renderLoop=function(i){let e=performance.now(),n=x===1/0?0:e-x,r=Math.min(n*c.getFrameRate()/1e3,c.getFrameRate());c.logicLoop(Math.max(Math.floor(v+r),1)),v=(v+r)%1;let t=Math.min(v-1,0);c.renderFrame(t,x),requestAnimationFrame(c.renderLoop)};c.logicLoop=function(i){performance.now(),c.tick(60/c.getFrameRate()*c.baseSpeed,i),x=performance.now()};globalThis.Zig={KeyBits:a,game_state_offsets:E};console.log('Note: engine is in verbose mode, but Zig code is not in -Doptimize=Debug; run just "zig build" to enable additional testing features and safety checks if possible.');setTimeout(function(){c.renderLoop(0)},17);

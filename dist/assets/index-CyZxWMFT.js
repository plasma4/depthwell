(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))i(e);new MutationObserver(e=>{for(const s of e)if(s.type==="childList")for(const o of s.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&i(o)}).observe(document,{childList:!0,subtree:!0});function n(e){const s={};return e.integrity&&(s.integrity=e.integrity),e.referrerPolicy&&(s.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?s.credentials="include":e.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function i(e){if(e.ep)return;e.ep=!0;const s=n(e);fetch(e.href,s)}})();const a={zoom:131072,mine:262144,inventory_up:524288,inventory_down:1048576,minus:32768,plus:65536,up:2048,left:4096,down:8192,right:16384,k0:1,k1:2,k2:4,k3:8,k4:16,k5:32,k6:64,k7:128,k8:256,k9:512},k={player_pos:0,last_player_pos:16,player_chunk:32,player_velocity:48,camera_pos:64,last_camera_pos:80,camera_scale:96,camera_scale_change:104,depth:112,player_quadrant:120,frame:124,keys_pressed_mask:128,keys_held_mask:132,seed:144,seed2:208},H="abcdefghijklmnopqrstuvwxyz",A=26n;function q(r=100){if(r<=0)return"";const t=new Uint8Array(72);crypto.getRandomValues(t);let n=0n;const i=new DataView(t.buffer);for(let o=0;o<t.length;o+=8)n=n<<64n|i.getBigUint64(o);let e="",s=n%A**BigInt(r);for(;s>=0n&&(e+=H[Number(s%A)],s=s/A-1n,!(s<0n)););return e}function W(r){let t=0n;for(let n=0;n<r.length;n++){const i=BigInt(r.charCodeAt(n)-97);t=t*A+(i+1n)}return t}async function K(r,t){const n=W(r),i=new DataView(new ArrayBuffer(64));for(let c=0;c<8;c++)i.setBigUint64(c*8,n>>BigInt((7-c)*64)&0xffffffffffffffffn);let e=new Uint8Array(i.buffer,0,32),s=new Uint8Array(i.buffer,32,32);const o=await Promise.all([0,1,2,3].map(c=>crypto.subtle.importKey("raw",new Uint8Array([c]),{name:"HMAC",hash:"SHA-256"},!1,["sign"])));for(const c of o){const f=new Uint8Array(await crypto.subtle.sign("HMAC",c,s)),p=new Uint8Array(32);for(let d=0;d<32;d++)p[d]=e[d]^f[d];e=s,s=p}const l=new Uint8Array(64);return l.set(e,0),l.set(s,32),t.set(new BigUint64Array(l.buffer)),t}const B={Minus:a.minus,Equal:a.plus,KeyZ:a.zoom,Backquote:a.mine,KeyQ:a.inventory_up,KeyE:a.inventory_down,Space:a.up,ArrowUp:a.up,KeyW:a.up,ArrowLeft:a.left,KeyA:a.left,ArrowDown:a.down,KeyS:a.down,ArrowRight:a.right,KeyD:a.right,Digit0:a.k0,Digit1:a.k1,Digit2:a.k2,Digit3:a.k3,Digit4:a.k4,Digit5:a.k5,Digit6:a.k6,Digit7:a.k7,Digit8:a.k8,Digit9:a.k9},I=a.up|a.down|a.left|a.right;function X(){let r={};const t={heldMask:0,keysHeld:0,keysPressed:0,currentlyHeld:0,horizontalPriority:0,verticalPriority:0,plusMinusPriority:0};function n(){r={},t.horizontalPriority=0,t.verticalPriority=0,t.plusMinusPriority=0,t.currentlyHeld=0,t.heldMask=0,t.keysPressed=0}return window.addEventListener("keydown",i=>{if(i.repeat)return;if(i.ctrlKey||i.metaKey){n();return}const e=B[i.code];e&&(e<=512&&(t.heldMask=t.heldMask&4294966272),t.heldMask|=e,e&I&&(r[e]=(r[e]||0)+1),e&(a.left|a.right)&&(t.horizontalPriority=e),e&(a.up|a.down)&&(t.verticalPriority=e),e&(a.plus|a.minus)&&(t.plusMinusPriority=e))}),window.addEventListener("keyup",i=>{const e=B[i.code];e&&(e&I?(r[e]=Math.max(0,(r[e]||0)-1),r[e]===0&&(t.heldMask&=~e)):t.heldMask&=~e,t.heldMask&e||(e===t.horizontalPriority&&(t.horizontalPriority=t.heldMask&a.left||t.heldMask&a.right||0),e===t.verticalPriority&&(t.verticalPriority=t.heldMask&a.up||t.heldMask&a.down||0),e===t.plusMinusPriority&&(t.plusMinusPriority=t.heldMask&a.plus||t.heldMask&a.minus||0)))}),window.addEventListener("blur",n),document.addEventListener("visibilitychange",n),window.addEventListener("contextmenu",n),t}function Z(r){const t=a.up|a.down|a.left|a.right;let n=r.heldMask&~t;n|=r.horizontalPriority,n|=r.verticalPriority,n|=r.plusMinusPriority,r.keysPressed=n&~r.keysHeld,r.currentlyHeld=n,r.keysHeld=n}const j=""+new URL("main-i2KLX81H.wasm",import.meta.url).href,Y=`/*
...
`,Q=""+new URL("main-BdprWHTI.png",import.meta.url).href,$="data:image/png;base64,";async function J(r,t){const n=await navigator.gpu.requestAdapter({powerPreference:t&&t.highPerformance?"high-performance":"low-power"});if(!n)throw new DOMException("Couldn't request WebGPU adapter.","NotSupportedError");const i=await n.requestDevice();let e=null;if(i.addEventListener("uncapturederror",_=>{const h=_.error;if(e===null)if(globalThis.reportError)reportError(h);else throw h;else if(!e.destroyed){e.destroy("fatal WebGPU error",h);return}}),i.lost.then(_=>console.error(`WebGPU Device lost: ${_.message}`)),r===void 0){if(r=document.getElementsByTagName("canvas")[0],r===void 0)throw Error("No canvas element or ID string provided, and no canvas was not found in the HTML.")}else if(typeof r=="string"){const _=document.getElementById(r);if(!(_ instanceof HTMLCanvasElement))throw Error(`Element with ID "${r}" is not a canvas element.`);r=_}const s=r.getContext("webgpu");if(!s)throw Error("Could not get WebGPU context from canvas.");const o=window.matchMedia("(color-gamut: p3)").matches,l=i.features.has("canvas-rgba16float-support")?"rgba16float":"bgra8unorm";s.configure({device:i,format:l,colorSpace:o&&l==="rgba16float"?"display-p3":"srgb",alphaMode:"opaque"});const c=await WebAssembly.instantiateStreaming(fetch(j),{env:{jsMessage:(_,h,y)=>{let g=new TextDecoder().decode(new Uint8Array(p.buffer,Number(_),Number(h)));g.charAt(0)!=="]"?g="["+(e.LOGGING_PREFIX||"")+g:g=g.slice(1),y===1?console.info("%c"+g,"font-weight: 600"):[console.log,console.info,console.warn,console.error][y](g)},jsWriteText:(_,h,y)=>{const g=new Uint8Array(p.buffer,Number(h),Number(y)),C=new TextDecoder().decode(g),V=document.getElementById(`text${_+1}`);V.textContent=C},jsGetTime:()=>performance.now(),jsHandleVisibleChunks:_=>e.handleVisibleChunks(_),jsHandleVisibleEntities:()=>e.handleVisibleEntities(),jsSetMouseType:_=>e.setMouseType(_)}}),f=c.instance.exports,p=f.memory,d=i.createShaderModule({label:"Main shader",code:Y.replace("/* TILES_PER_ROW */ 1 /* TILES_PER_ROW */",""+f.getTilesPerRow()).replace("/* TILES_PER_COLUMN */ 1 /* TILES_PER_COLUMN */",""+f.getTilesPerColumn()).replace("/* STONE_START */ 1 /* STONE_START */",""+f.getStoneStart()).replace("/* ORE_START */ 1 /* ORE_START */",""+f.getOreStart()).replace("/* GEM_START */ 1 /* GEM_START */",""+f.getGemStart()).replace("/* GEM_MASK_START */ 1 /* GEM_MASK_START */",""+f.getGemMaskStart()).replace("/* DECOR_START */ 1 /* DECOR_START */",""+f.getDecorStart())}),m=i.createBindGroupLayout({label:"Main bind group layout",entries:[{binding:0,visibility:GPUShaderStage.VERTEX|GPUShaderStage.FRAGMENT,buffer:{type:"uniform",hasDynamicOffset:!0}},{binding:1,visibility:GPUShaderStage.VERTEX|GPUShaderStage.FRAGMENT,buffer:{type:"read-only-storage"}},{binding:2,visibility:GPUShaderStage.FRAGMENT,texture:{}},{binding:3,visibility:GPUShaderStage.FRAGMENT,texture:{}},{binding:4,visibility:GPUShaderStage.FRAGMENT,sampler:{}},{binding:5,visibility:GPUShaderStage.VERTEX|GPUShaderStage.FRAGMENT,buffer:{type:"read-only-storage"}}]}),S=i.createPipelineLayout({label:"Shared Pipeline Layout",bindGroupLayouts:[m]}),O=i.createRenderPipeline({label:"Tilemap pipeline",layout:S,vertex:{module:d,entryPoint:"vs_tile"},fragment:{module:d,entryPoint:"fs_main",targets:[{format:l,blend:{color:{srcFactor:"src-alpha",dstFactor:"one-minus-src-alpha"},alpha:{srcFactor:"one",dstFactor:"one-minus-src-alpha"}}}]},primitive:{topology:"triangle-list",cullMode:"none"}}),M=i.createRenderPipeline({label:"Background pipeline",layout:S,vertex:{module:d,entryPoint:"vs_background"},fragment:{module:d,entryPoint:"fs_background",targets:[{format:l}]},primitive:{topology:"triangle-list"}}),G=i.createRenderPipeline({label:"Entity pipeline",layout:S,vertex:{module:d,entryPoint:"vs_entity"},fragment:{module:d,entryPoint:"fs_entity",targets:[{format:l,blend:{color:{srcFactor:"src-alpha",dstFactor:"one-minus-src-alpha"},alpha:{srcFactor:"one",dstFactor:"one-minus-src-alpha"}}}]},primitive:{topology:"triangle-list"}});e=new E(r,n,i,s,c,O,M,G),e.exports.setup(),await e.setSeed(q(100)),e.startDelta=Number(f.mixSeed(60n)%120000n),e.exports.init();const D=new ResizeObserver(e.onResize);e.resizeObserver=D,e.updateCanvasStyle();try{e.resizeObserver.observe(r,{box:"device-pixel-content-box"})}catch{console.log("ResizeObserver property device-pixel-content-box not supported, falling back to content-box."),e.resizeObserver.observe(r,{box:"content-box"})}e.onResize([{contentRect:{width:r.clientWidth,height:r.clientHeight}}]);const F=await E.loadTexture(i,Q),N=await E.loadTexture(i,$),z=i.createSampler({magFilter:"nearest",minFilter:"nearest",addressModeU:"clamp-to-edge",addressModeV:"clamp-to-edge"});return e.atlasTextureView=F.createView(),e.atlasTextureMaskView=N.createView(),e.pixelSampler=z,e.uniformBuffer=i.createBuffer({label:"SceneUniforms",size:256*v,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),e.entityBuffer=e.device.createBuffer({label:"Entities",size:2400,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST}),e.isP3=o&&l==="rgba16float",e.is8Bit=l==="bgra8unorm",e.gamutMediaQuery=window.matchMedia("(color-gamut: p3)"),e.gamutMediaQuery.addEventListener("change",_=>{const h=_.matches&&l==="rgba16float";h!==e.isP3&&(e.isP3=h,s.configure({device:i,format:l,colorSpace:h?"display-p3":"srgb",alphaMode:"opaque"}))}),e}var U=(r=>(r[r.Uint8=8]="Uint8",r[r.Uint16=16]="Uint16",r[r.Uint32=32]="Uint32",r[r.Uint64=64]="Uint64",r[r.Int8=-8]="Int8",r[r.Int16=-16]="Int16",r[r.Int32=-32]="Int32",r[r.Int64=-64]="Int64",r[r.Uint8Clamped=-80]="Uint8Clamped",r[r.Float32=-320]="Float32",r[r.Float64=-640]="Float64",r))(U||{});globalThis.WasmTypeCode=U;const L={8:Uint8Array,16:Uint16Array,32:Uint32Array,64:BigUint64Array,[-8]:Int8Array,[-16]:Int16Array,[-32]:Int32Array,[-64]:BigInt64Array,[-80]:Uint8ClampedArray,[-320]:Float32Array,[-640]:Float64Array},v=4;class E{engineModule;exports;memory;LAYOUT_PTR;GAME_STATE_PTR;mouseType;canvas;adapter;device;context;bindGroups=Array(v);uniformBuffer;tileBuffers=Array(v);entityBuffer;tileBufferDirty=!1;atlasTextureView;atlasTextureMaskView;pixelSampler;tilePipeline;bgPipeline;entityPipeline;renderPass=null;currentEncoder=null;currentTextureView=null;renderCallId=0;sceneDataBuffer=new ArrayBuffer(256);sceneDataF32=new Float32Array(this.sceneDataBuffer);sceneDataU32=new Uint32Array(this.sceneDataBuffer);inputState;resizeObserver;forceAspectRatio=!0;previousForceAspectRatio=null;tileMapWidth;tileMapHeight;last_upload_visible_chunks_time=0;prepare_visible_data_time=0;isVisibleDataNew=!0;wireframeOpacity=0;startTime=performance.now();startDelta;seed="";destroyed=!1;destroyedError=null;encoder=new TextEncoder;decoder=new TextDecoder;isP3=!1;is8Bit=!1;gamutMediaQuery=null;LOGGING_PREFIX="";constructor(t,n,i,e,s,o,l,c){this.canvas=t,this.adapter=n,this.device=i,this.context=e,this.engineModule=s,this.tilePipeline=o,this.bgPipeline=l,this.entityPipeline=c,this.exports=s.instance.exports,this.memory=s.instance.exports.memory,this.LAYOUT_PTR=Number(this.exports.getMemoryLayoutPtr()),this.GAME_STATE_PTR=Number(this.getScratchView()[3]),this.inputState=X()}static async create(t,n){return await J(t,n)}destroy(t="unknown reason",n=null){this.resizeObserver.disconnect(),this.destroyed=t,this.destroyedError=n}static async loadTexture(t,n){const e=await(await fetch(n)).blob(),s=await createImageBitmap(e),o=t.createTexture({label:`Texture from ${n}`,size:[s.width,s.height],format:t.features.has("canvas-rgba16float-support")?"rgba16float":"bgra8unorm",usage:GPUTextureUsage.TEXTURE_BINDING|GPUTextureUsage.COPY_DST|GPUTextureUsage.RENDER_ATTACHMENT});return t.queue.copyExternalImageToTexture({source:s},{texture:o},[s.width,s.height]),o}uploadVisibleChunks(t=1){const n=performance.now();this.exports.prepareVisibleData(t,n-this.last_upload_visible_chunks_time,this.canvas.width,this.canvas.height),this.last_upload_visible_chunks_time=n,this.prepare_visible_data_time=performance.now()-n}handleVisibleChunks(t){if(!this.currentEncoder||!this.currentTextureView||!this.renderPass)return;const n=this.getScratchPtr();if(this.getScratchLen()===0)return;const e=Number(this.getScratchProperty(0)),s=Number(this.getScratchProperty(1)),o=e*s*2;this.tileMapWidth=e,this.tileMapHeight=s;const l=new Uint32Array(this.memory.buffer,n,o);this.recreateBufferAndBindGroup(o*4),this.renderPass.setPipeline(this.tilePipeline),this.renderPass.setBindGroup(0,this.bindGroups[this.renderCallId],[this.renderCallId*256]),this.renderPass.setViewport(0,0,this.canvas.width,this.canvas.height,0,1),this.setSceneData(t,e,s),this.device.queue.writeBuffer(this.tileBuffers[this.renderCallId],0,l);const c=e*s+1;this.renderPass.draw(6,c),this.renderCallId++}handleVisibleEntities(){this.renderCallId=0;const t=this.getScratchPtr(),n=this.getScratchProperty(0)*48;if(n===0||!this.renderPass)return;this.entityBuffer.size<n&&(this.entityBuffer=this.device.createBuffer({label:"Entities",size:n,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST}),this.recreateBufferAndBindGroup(0));const i=new Uint8Array(this.memory.buffer,t,n);this.device.queue.writeBuffer(this.entityBuffer,0,i),this.renderPass.setPipeline(this.entityPipeline),this.renderPass.setBindGroup(0,this.bindGroups[0],[0]),this.renderPass.draw(8,n/48)}setMouseType(t){t==0?this.mouseType!=0&&(this.canvas.style.cursor=null):t==1&&this.mouseType!=0&&(this.canvas.style.cursor="pointer"),this.mouseType=t}setSceneData(t,n,i){const e=this.getScratchProperty(2,-640),s=this.getScratchProperty(3,-640),o=this.getScratchProperty(4,-640),l=this.getScratchProperty(5,-640),c=this.getScratchProperty(6,-640);this.sceneDataF32[0]=e,this.sceneDataF32[1]=s,this.sceneDataF32[2]=this.canvas.width,this.sceneDataF32[3]=this.canvas.height;const f=12e4,d=(performance.now()-this.startTime+this.startDelta)%(f*2);let m;d<f?m=d/1e3:m=(f-(d-f))/1e3,this.sceneDataF32[4]=m,this.sceneDataF32[5]=o,this.sceneDataF32[6]=o<.25?0:this.wireframeOpacity,this.sceneDataF32[7]=t,this.sceneDataF32[8]=l,this.sceneDataF32[9]=c,this.sceneDataU32[10]=n,this.sceneDataU32[11]=i,this.sceneDataU32[12]=this.isP3?1:0,this.sceneDataU32[13]=this.is8Bit?1:0,this.device.queue.writeBuffer(this.uniformBuffer,this.renderCallId*256,this.sceneDataF32)}recreateBufferAndBindGroup(t){const n=this.renderCallId;(t===0||!this.tileBuffers[n]||this.tileBuffers[n].size<t)&&(this.tileBuffers[n]=this.device.createBuffer({label:`Tile grid slot ${n}`,size:Math.max(t,256*v),usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST}),this.bindGroups[n]=this.device.createBindGroup({label:`Bind group slot ${n}`,layout:this.tilePipeline.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:this.uniformBuffer,offset:0,size:256}},{binding:1,resource:{buffer:this.tileBuffers[n]}},{binding:2,resource:this.atlasTextureView},{binding:3,resource:this.atlasTextureMaskView},{binding:4,resource:this.pixelSampler},{binding:5,resource:{buffer:this.entityBuffer}}]}))}getWASMMemoryMB(){return this.memory.buffer.byteLength/1024/1024}getGameView(t,n=0,i){return new L[t](this.memory.buffer,this.GAME_STATE_PTR+n,i)}getRawView(t,n,i){return new L[t](this.memory.buffer,n,i)}_tempScratchViewU64=null;_tempScratchViewF64=null;getScratchView(){return(this._tempScratchViewU64===null||this._tempScratchViewU64.buffer!==this.memory.buffer)&&(this._tempScratchViewU64=new BigUint64Array(this.memory.buffer,this.LAYOUT_PTR,24)),this._tempScratchViewU64}getScratchPtr(){return Number(this.getScratchView()[0])}getScratchLen(){return Number(this.getScratchView()[1])}setScratchLen(t){this.getScratchView()[1]=BigInt(t)}getScratchCapacity(){return Number(this.getScratchView()[2])}getScratchProperty(t,n=64){(this._tempScratchViewU64===null||this._tempScratchViewU64.buffer!==this.memory.buffer)&&(this._tempScratchViewU64=new BigUint64Array(this.memory.buffer,this.LAYOUT_PTR,24));let i=this._tempScratchViewU64;return n==-640&&((this._tempScratchViewF64===null||this._tempScratchViewF64.buffer!==this.memory.buffer)&&(this._tempScratchViewF64=new Float64Array(i.buffer,i.byteOffset,i.length)),i=this._tempScratchViewF64),Number(i[t+4])}readStr(t=this.getScratchPtr(),n=this.getScratchLen()){const i=new Uint8Array(this.memory.buffer,t,n);return this.decoder.decode(i)}writeStr(t,n=!0){const i=t.length;if(i===0)return null;n&&this.setScratchLen(0);const e=this.exports.scratchAlloc(i);if(e===0n)return null;const s=new Uint8Array(this.memory.buffer,Number(e),i);if(this.encoder.encodeInto(t,s).read<i)throw new RangeError("String truncated with non-ASCII characters detected.");return Number(e)}async setSeed(t){this.seed=t,await K(t,this.getGameView(64,k.seed,8))}updateCanvasStyle(){this.forceAspectRatio!==this.previousForceAspectRatio&&(this.previousForceAspectRatio=this.forceAspectRatio,this.forceAspectRatio?(this.canvas.style.maxWidth=`calc(100vh*${16/9})`,this.canvas.style.maxHeight=`calc(100vw*${9/16})`):(this.canvas.style.maxWidth="none",this.canvas.style.maxHeight="none"))}onResize=t=>{const n=t[0];let i,e;if(n.devicePixelContentBoxSize)i=n.devicePixelContentBoxSize[0].inlineSize,e=n.devicePixelContentBoxSize[0].blockSize;else if(n.contentBoxSize){const s=n.contentBoxSize[0].inlineSize,o=n.contentBoxSize[0].blockSize;i=Math.round(s*devicePixelRatio),e=Math.round(o*devicePixelRatio)}else{const s=n.contentRect.width,o=n.contentRect.height;i=Math.round(s*devicePixelRatio),e=Math.round(o*devicePixelRatio)}(this.canvas.width!==i||this.canvas.height!==e)&&(this.canvas.width=i,this.canvas.height=e)};renderFrame(t,n){if(this.renderCallId=0,this.destroyed!==!1)return;this.updateCanvasStyle(),this.currentEncoder=this.device.createCommandEncoder(),this.currentTextureView=this.context.getCurrentTexture().createView();const i=this.currentEncoder.beginRenderPass({colorAttachments:[{view:this.currentTextureView,loadOp:"clear",clearValue:{r:0,g:0,b:0,a:1},storeOp:"store"}]});this.renderPass=i,this.recreateBufferAndBindGroup(256*v),this.sceneDataF32[7]=1,this.sceneDataU32[12]=this.isP3?1:0,this.sceneDataU32[13]=this.is8Bit?1:0,this.device.queue.writeBuffer(this.uniformBuffer,this.renderCallId*256,this.sceneDataF32),this.renderPass.setPipeline(this.bgPipeline),this.renderPass.setBindGroup(0,this.bindGroups[this.renderCallId],[this.renderCallId++*256]),this.renderPass.draw(3),this.uploadVisibleChunks(t),this.renderPass.end(),this.device.queue.submit([this.currentEncoder.finish()]),this.currentEncoder=null,this.currentTextureView=null}tick(t,n){const i=this.getGameView(32,k.keys_pressed_mask,2);Z(this.inputState),i[0]=this.inputState.keysPressed,i[1]=this.inputState.keysHeld,this.exports.tick(t,n)}}location.protocol==="file:"&&alert("This game cannot run from a local file:// context; use an online version or test from localhost instead.");isSecureContext||alert("This game cannot run in a non-secure context.");navigator.gpu||alert("WebGPU is not supported by your browser; try playing this on an alternate or more modern browser.");const ee=await navigator.gpu.requestAdapter();ee||alert("WebGPU is supported, but no compatible GPU was found.");globalThis.Zig={KeyBits:a,game_state_offsets:k};console.log("Zig code is in debug mode. Use engine.exports to see its functions, variables, and memory, such as engine.exports.test_logs."),document.body.innerHTML+=`
    <div id="textTop">
        <div id="text1"></div>
        <div id="text2"></div>
    </div>
    ...
    <div id="debugContainer"></div>`;{const r=(t,n,i,e)=>{const s=t||{};let l=`An error occurred: ${s.message||String(t||"Unknown error")}`;const c=i||s.line,f=e||s.column;if(n||c||f){const d=n?n.split("/").pop()||n:"unknown";l+=`
Source: ${d}:${c||"?"}:${f||"?"}`}let p=globalThis.engine?.destroyedError;if(globalThis.engine?.destroyedError&&(l+=`
Details: ${p.message||p}`),s.stack)l+=`

Stack trace:
${s.stack}`;else if(typeof t=="object"&&t!==null)try{const d=JSON.stringify(t);d!=="{}"&&(l+=`
Object state: ${d}`)}catch{l+=`
(Object state hidden: circular reference)`}alert(l)};window.onerror=(t,n,i,e,s)=>{r(s||t,n,i,e)},window.onunhandledrejection=t=>{r(t.reason)},console.error=(...t)=>{const n=t.find(i=>i instanceof Error)||t[0];r(n)}}document.addEventListener("wheel",function(r){r.ctrlKey},{passive:!1});let u=await E.create();u.getTimeoutLength=function(){return++te%3==2?16:17};u.getFrameRate=function(){return 60};u.baseSpeed=1;let b=performance.now(),x=0,te=0;const w=Array(60).fill(0),R=Array(60).fill(0),P=Array(60).fill(0);u.isDebug=!!u.exports.isDebug();u.renderLoop=function(r){let t=performance.now(),n=b===1/0?0:t-b;b=t;const i=1e3/u.getFrameRate(),e=n/i,s=Math.min(x+e,5);let o=Math.floor(s);o>0?(u.logicLoop(o),x=s-o):x=s;{R.shift(),R.push(n),P.shift(),P.push(u.prepare_visible_data_time);const c=Math.max.apply(null,R),f=Math.max.apply(null,P);let p="#cccccc";c>55?p="#e83769":c>30?p="#f39c19":c>20&&(p="#f7ce1a");const d=document.getElementById("renderText");d.textContent=`Time since last render/prepare_visible_data time: ${n.toFixed(1)}ms, ${u.prepare_visible_data_time.toFixed(1)}ms
Worst (past 60 frames): ${c.toFixed(1)}ms, ${f.toFixed(1)}ms`,d.style.fontWeight=c>40?c>55?700:600:500,d.style.color=p}let l=Math.min(x-1,0);u.renderFrame(l,b),requestAnimationFrame(u.renderLoop)};u.logicLoop=function(r){const t=performance.now(),n=60/u.getFrameRate()*u.baseSpeed;u.tick(n,r);let i=performance.now()-t;{w.shift(),w.push(i);const e=Math.max.apply(null,w);let s="#cccccc";e>30?s="#e83769":e>15?s="#f39c19":e>10&&(s="#f7ce1a");const o=document.getElementById("logicText");o.textContent=`Logic diff: ${i.toFixed(1)}ms for ${r} tick${r==1?"":"s"}
Worst (past 60 frames): ${e.toFixed(1)}ms
`,o.style.fontWeight=e>20?e>40?700:600:500,o.style.color=s}};const T=(r,t)=>{const n=u.canvas.getBoundingClientRect();if(r==null){u.exports.handleMouse(-1,-1,5);return}const i=(r.clientX-n.left)/n.width,e=(r.clientY-n.top)/n.height;i>=0&&i<=1&&e>=0&&e<=1?u.exports.handleMouse(i,e,t):u.exports.handleMouse(-1,-1,t)};window.addEventListener("blur",()=>{b=1/0,T(null,0)});document.addEventListener("pointermove",r=>{T(r,0)});document.addEventListener("pointerdown",r=>{const t=r.target;if(!t||document.getElementById("debugContainer").contains(t))return;const n=r.button===2?3:1;T(r,n)});document.addEventListener("pointerup",r=>{const t=r.button===2?4:2;T(r,t)});u.canvas.style.touchAction="none";document.addEventListener("contextmenu",r=>r.preventDefault());{u.exports.debugBuildUiMetadata();const r=u.readStr(),t=JSON.parse(r),n=document.getElementById("debugContainer");t.buttons.forEach(i=>{const e=document.createElement("button");e.textContent=i.name,e.onclick=()=>u.exports.clickDebugUiButton(i.id),n.appendChild(e)}),t.sliders.forEach(i=>{const e=document.createElement("div");e.style.display="flex",e.style.flexDirection="column";const s=document.createElement("label");s.textContent=`${i.name}: ${i.val.toFixed(2)}`,s.style.fontSize="12px";const o=document.createElement("input");o.type="range",o.min=i.min,o.max=i.max,o.step=((i.max-i.min)/1e3).toString(),o.value=i.val,o.oninput=l=>{const c=parseFloat(l.target.value);s.textContent=`${i.name}: ${c.toFixed(2)}`,u.exports.changeDebugUiSlider(i.id,c)},e.appendChild(s),e.appendChild(o),n.appendChild(e)}),document.body.appendChild(n)}setTimeout(function(){u.renderLoop(0)},17);

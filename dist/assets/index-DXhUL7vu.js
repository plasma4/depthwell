(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))s(e);new MutationObserver(e=>{for(const i of e)if(i.type==="childList")for(const o of i.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&s(o)}).observe(document,{childList:!0,subtree:!0});function n(e){const i={};return e.integrity&&(i.integrity=e.integrity),e.referrerPolicy&&(i.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?i.credentials="include":e.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function s(e){if(e.ep)return;e.ep=!0;const i=n(e);fetch(e.href,i)}})();const a={zoom:131072,drop:262144,minus:32768,plus:65536,up:2048,left:4096,down:8192,right:16384,k0:1,k1:2,k2:4,k3:8,k4:16,k5:32,k6:64,k7:128,k8:256,k9:512},T={player_pos:0,last_player_pos:16,player_chunk:32,player_velocity:48,camera_pos:64,last_camera_pos:80,camera_scale:96,camera_scale_change:104,depth:112,player_quadrant:120,player_screen_offset:128,keys_pressed_mask:136,keys_held_mask:140,seed:144,seed2:208},z="abcdefghijklmnopqrstuvwxyz",v=26n;function q(r=100){if(r<=0)return"";const t=new Uint8Array(72);crypto.getRandomValues(t);let n=0n;const s=new DataView(t.buffer);for(let o=0;o<t.length;o+=8)n=n<<64n|s.getBigUint64(o);let e="",i=n%v**BigInt(r);for(;i>=0n&&(e+=z[Number(i%v)],i=i/v-1n,!(i<0n)););return e}function F(r){let t=0n;for(let n=0;n<r.length;n++){const s=BigInt(r.charCodeAt(n)-97);t=t*v+(s+1n)}return t}async function N(r,t){const n=F(r),s=new DataView(new ArrayBuffer(64));for(let c=0;c<8;c++)s.setBigUint64(c*8,n>>BigInt((7-c)*64)&0xffffffffffffffffn);let e=new Uint8Array(s.buffer,0,32),i=new Uint8Array(s.buffer,32,32);const o=await Promise.all([0,1,2,3].map(c=>crypto.subtle.importKey("raw",new Uint8Array([c]),{name:"HMAC",hash:"SHA-256"},!1,["sign"])));for(const c of o){const h=new Uint8Array(await crypto.subtle.sign("HMAC",c,i)),g=new Uint8Array(32);for(let u=0;u<32;u++)g[u]=e[u]^h[u];e=i,i=g}const d=new Uint8Array(64);return d.set(e,0),d.set(i,32),t.set(new BigUint64Array(d.buffer)),t}const S={Minus:a.minus,Equal:a.plus,KeyZ:a.zoom,KeyQ:a.drop,ArrowUp:a.up,KeyW:a.up,ArrowLeft:a.left,KeyA:a.left,ArrowDown:a.down,KeyS:a.down,ArrowRight:a.right,KeyD:a.right,Digit0:a.k0,Digit1:a.k1,Digit2:a.k2,Digit3:a.k3,Digit4:a.k4,Digit5:a.k5,Digit6:a.k6,Digit7:a.k7,Digit8:a.k8,Digit9:a.k9};function V(){let r={};const t={heldMask:0,keysHeld:0,keysPressed:0,currentlyHeld:0,horizontalPriority:0,verticalPriority:0,plusMinusPriority:0};function n(){r={},t.horizontalPriority=0,t.verticalPriority=0,t.plusMinusPriority=0,t.currentlyHeld=0,t.heldMask=0,t.keysPressed=0}return window.addEventListener("keydown",s=>{if(s.repeat||s.altKey||s.ctrlKey||s.metaKey||s.shiftKey)return;const e=S[s.code];e&&(t.heldMask|=e,r[e]=(r[e]||0)+1,e&(a.left|a.right)&&(t.horizontalPriority=e),e&(a.up|a.down)&&(t.verticalPriority=e),e&(a.plus|a.minus)&&(t.plusMinusPriority=e))}),window.addEventListener("keyup",s=>{const e=S[s.code];e&&(r[e]=Math.max(0,(r[e]||0)-1),r[e]===0&&(t.heldMask&=~e,e===t.horizontalPriority&&(t.horizontalPriority=t.heldMask&a.left||t.heldMask&a.right||0),e===t.verticalPriority&&(t.verticalPriority=t.heldMask&a.up||t.heldMask&a.down||0),e===t.plusMinusPriority&&(t.plusMinusPriority=t.heldMask&a.plus||t.heldMask&a.minus||0)))}),window.addEventListener("blur",n),document.addEventListener("visibilitychange",n),window.addEventListener("contextmenu",n),t}function H(r){const t=a.up|a.down|a.left|a.right;let n=r.heldMask&~t;n|=r.horizontalPriority,n|=r.verticalPriority,n|=r.plusMinusPriority,r.keysPressed=n&~r.keysHeld,r.currentlyHeld=n,r.keysHeld=n}const C=""+new URL("main-BB8ITO2C.wasm",import.meta.url).href,Z=`/*
...
`,e.style.fontWeight=n>30?n>55?700:600:500,e.style.color=s}};globalThis.Zig={KeyBits:a,game_state_offsets:T};l.isDebug?(console.log("Zig code is in debug mode. Use engine.exports to see its functions, variables, and memory, such as engine.exports.test_logs."),l.wireframeOpacity=1/3,W.forEach(r=>{document.getElementById(r).style.display="inline"})):console.log('Note: engine is in verbose mode, but Zig code is not in -Doptimize=Debug; run just "zig build" to enable additional testing features and safety checks if possible.');setTimeout(function(){l.renderLoop(0)},17);

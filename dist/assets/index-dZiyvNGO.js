(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))s(e);new MutationObserver(e=>{for(const i of e)if(i.type==="childList")for(const a of i.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&s(a)}).observe(document,{childList:!0,subtree:!0});function n(e){const i={};return e.integrity&&(i.integrity=e.integrity),e.referrerPolicy&&(i.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?i.credentials="include":e.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function s(e){if(e.ep)return;e.ep=!0;const i=n(e);fetch(e.href,i)}})();const o={zoom:131072,drop:262144,minus:32768,plus:65536,up:2048,left:4096,down:8192,right:16384,k0:1,k1:2,k2:4,k3:8,k4:16,k5:32,k6:64,k7:128,k8:256,k9:512},A={player_pos:0,last_player_pos:16,player_chunk:32,player_velocity:48,camera_pos:64,last_camera_pos:80,camera_scale:96,camera_scale_change:104,depth:112,player_quadrant:120,player_screen_offset:128,keys_pressed_mask:136,keys_held_mask:140,seed:144,seed2:208},z="abcdefghijklmnopqrstuvwxyz",v=26n;function q(r=100){if(r<=0)return"";const t=new Uint8Array(72);crypto.getRandomValues(t);let n=0n;const s=new DataView(t.buffer);for(let a=0;a<t.length;a+=8)n=n<<64n|s.getBigUint64(a);let e="",i=n%v**BigInt(r);for(;i>=0n&&(e+=z[Number(i%v)],i=i/v-1n,!(i<0n)););return e}function F(r){let t=0n;for(let n=0;n<r.length;n++){const s=BigInt(r.charCodeAt(n)-97);t=t*v+(s+1n)}return t}async function N(r,t){const n=F(r),s=new DataView(new ArrayBuffer(64));for(let c=0;c<8;c++)s.setBigUint64(c*8,n>>BigInt((7-c)*64)&0xffffffffffffffffn);let e=new Uint8Array(s.buffer,0,32),i=new Uint8Array(s.buffer,32,32);const a=await Promise.all([0,1,2,3].map(c=>crypto.subtle.importKey("raw",new Uint8Array([c]),{name:"HMAC",hash:"SHA-256"},!1,["sign"])));for(const c of a){const h=new Uint8Array(await crypto.subtle.sign("HMAC",c,i)),g=new Uint8Array(32);for(let u=0;u<32;u++)g[u]=e[u]^h[u];e=i,i=g}const d=new Uint8Array(64);return d.set(e,0),d.set(i,32),t.set(new BigUint64Array(d.buffer)),t}const S={Minus:o.minus,Equal:o.plus,KeyZ:o.zoom,KeyQ:o.drop,ArrowUp:o.up,KeyW:o.up,ArrowLeft:o.left,KeyA:o.left,ArrowDown:o.down,KeyS:o.down,ArrowRight:o.right,KeyD:o.right,Digit0:o.k0,Digit1:o.k1,Digit2:o.k2,Digit3:o.k3,Digit4:o.k4,Digit5:o.k5,Digit6:o.k6,Digit7:o.k7,Digit8:o.k8,Digit9:o.k9};function V(){let r={};const t={heldMask:0,keysHeld:0,keysPressed:0,currentlyHeld:0,horizontalPriority:0,verticalPriority:0,plusMinusPriority:0};function n(){r={},t.horizontalPriority=0,t.verticalPriority=0,t.plusMinusPriority=0,t.currentlyHeld=0,t.heldMask=0,t.keysPressed=0}return window.addEventListener("keydown",s=>{if(s.repeat||s.altKey||s.ctrlKey||s.metaKey||s.shiftKey)return;const e=S[s.code];e&&(t.heldMask|=e,r[e]=(r[e]||0)+1,e&(o.left|o.right)&&(t.horizontalPriority=e),e&(o.up|o.down)&&(t.verticalPriority=e),e&(o.plus|o.minus)&&(t.plusMinusPriority=e))}),window.addEventListener("keyup",s=>{const e=S[s.code];e&&(r[e]=Math.max(0,(r[e]||0)-1),r[e]===0&&(t.heldMask&=~e,e===t.horizontalPriority&&(t.horizontalPriority=t.heldMask&o.left||t.heldMask&o.right||0),e===t.verticalPriority&&(t.verticalPriority=t.heldMask&o.up||t.heldMask&o.down||0),e===t.plusMinusPriority&&(t.plusMinusPriority=t.heldMask&o.plus||t.heldMask&o.minus||0)))}),window.addEventListener("blur",n),document.addEventListener("visibilitychange",n),window.addEventListener("contextmenu",n),t}function H(r){const t=o.up|o.down|o.left|o.right;let n=r.heldMask&~t;n|=r.horizontalPriority,n|=r.verticalPriority,n|=r.plusMinusPriority,r.keysPressed=n&~r.keysHeld,r.currentlyHeld=n,r.keysHeld=n}const C=""+new URL("main-swdKrpkn.wasm",import.meta.url).href,Z=`/*
...
`,K="data:image/png;base64,";async function j(r,t){const n={highPerformance:!1,...t},s=await navigator.gpu.requestAdapter({powerPreference:n.highPerformance?"high-performance":"low-power"});if(!s)throw new DOMException("Couldn't request WebGPU adapter.","NotSupportedError");const e=await s.requestDevice();let i=null;if(e.addEventListener("uncapturederror",f=>{const p=f.error;if(i===null)if(globalThis.reportError)reportError(p);else throw p;else if(!i.destroyed){i.destroy("fatal WebGPU error",p);return}}),e.lost.then(f=>console.error(`WebGPU Device lost: ${f.message}`)),r===void 0){if(r=document.getElementsByTagName("canvas")[0],r===void 0)throw Error("No canvas element or ID string provided, and no canvas was not found in the HTML.")}else if(typeof r=="string"){const f=document.getElementById(r);if(!(f instanceof HTMLCanvasElement))throw Error(`Element with ID "${r}" is not a canvas element.`);r=f}const a=r.getContext("webgpu");if(!a)throw Error("Could not get WebGPU context from canvas.");const d=e.features.has("canvas-rgba16float-support")?"rgba16float":"bgra8unorm";a.configure({device:e,format:d,alphaMode:"opaque"});const c=await WebAssembly.instantiateStreaming(fetch(C),{env:{js_message:(f,p,x)=>{let _=new TextDecoder().decode(new Uint8Array(g.buffer,Number(f),Number(p)));_.charAt(0)!=="]"?_="["+(i?.LOGGING_PREFIX||"")+_:_=_.slice(1),x===1?console.info("%c"+_,"font-weight: 600"):[console.log,console.info,console.warn,console.error][x](_)},js_write_text:(f,p,x)=>{const _=new Uint8Array(g.buffer,Number(p),Number(x)),M=new TextDecoder().decode(_),U=document.getElementById(`text${f+1}`);U.textContent=M},js_get_time:()=>performance.now(),js_handle_visible_chunks:f=>i?.handleVisibleChunks(f)}}),h=c.instance.exports,g=h.memory,u=e.createShaderModule({label:"Main shader",code:Z.replace("/* TILES_PER_ROW */ 1.0 /* TILES_PER_ROW */",""+h.get_tiles_per_row()).replace("/* TILES_PER_COLUMN */ 1.0 /* TILES_PER_COLUMN */",""+h.get_tiles_per_column())}),y=e.createBindGroupLayout({label:"Main bind group layout",entries:[{binding:0,visibility:GPUShaderStage.VERTEX|GPUShaderStage.FRAGMENT,buffer:{type:"uniform"}},{binding:1,visibility:GPUShaderStage.VERTEX|GPUShaderStage.FRAGMENT,buffer:{type:"read-only-storage"}},{binding:2,visibility:GPUShaderStage.FRAGMENT,texture:{}},{binding:3,visibility:GPUShaderStage.FRAGMENT,sampler:{}}]}),k=e.createPipelineLayout({label:"Shared Pipeline Layout",bindGroupLayouts:[y]}),I=e.createRenderPipeline({label:"Tilemap pipeline",layout:k,vertex:{module:u,entryPoint:"vs_main"},fragment:{module:u,entryPoint:"fs_main",targets:[{format:d,blend:{color:{srcFactor:"src-alpha",dstFactor:"one-minus-src-alpha"},alpha:{srcFactor:"one",dstFactor:"one-minus-src-alpha"}}}]},primitive:{topology:"triangle-list",cullMode:"none"}}),D=e.createRenderPipeline({label:"Background pipeline",layout:k,vertex:{module:u,entryPoint:"vs_background"},fragment:{module:u,entryPoint:"fs_background",targets:[{format:d}]},primitive:{topology:"triangle-list"}});i=new T(r,s,e,a,c,I,D),i.exports.setup(),await i.setSeed(q(100)),i.exports.init();const L=new ResizeObserver(i.onResize);i.resizeObserver=L,i.updateCanvasStyle();try{i.resizeObserver.observe(r,{box:"device-pixel-content-box"})}catch{console.log("ResizeObserver property device-pixel-content-box not supported, falling back to content-box."),i.resizeObserver.observe(r,{box:"content-box"})}i.onResize([{contentRect:{width:r.clientWidth,height:r.clientHeight}}]);const R=await T.loadTexture(e,K),G=e.createSampler({magFilter:"nearest",minFilter:"nearest",addressModeU:"clamp-to-edge",addressModeV:"clamp-to-edge"});i.atlasTextureView=R.createView(),i.pixelSampler=G;const O=e.createBuffer({label:"SceneUniforms",size:56,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST});return i.uniformBuffer=O,i}var B=(r=>(r[r.Uint8=8]="Uint8",r[r.Uint16=16]="Uint16",r[r.Uint32=32]="Uint32",r[r.Uint64=64]="Uint64",r[r.Int8=-8]="Int8",r[r.Int16=-16]="Int16",r[r.Int32=-32]="Int32",r[r.Int64=-64]="Int64",r[r.Uint8Clamped=-80]="Uint8Clamped",r[r.Float32=-320]="Float32",r[r.Float64=-640]="Float64",r))(B||{});globalThis.WasmTypeCode=B;const P={8:Uint8Array,16:Uint16Array,32:Uint32Array,64:BigUint64Array,[-8]:Int8Array,[-16]:Int16Array,[-32]:Int32Array,[-64]:BigInt64Array,[-80]:Uint8ClampedArray,[-320]:Float32Array,[-640]:Float64Array};class T{engineModule;exports;memory;canvas;adapter;device;context;resizeObserver;inputState;prepare_visible_chunks_time=0;isVisibleDataNew=!0;tileMapWidth;tileMapHeight;destroyed=!1;bindGroup;uniformBuffer;tileBuffer;tileBufferDirty=!1;atlasTextureView;pixelSampler;startTime=performance.now();LAYOUT_PTR;GAME_STATE_PTR;seed="";destroyedError=null;wireframeOpacity=0;forceAspectRatio=!0;previousForceAspectRatio=null;renderCallId=0;renderPass=null;currentEncoder=null;currentTextureView=null;sceneDataBuffer=new ArrayBuffer(56);sceneDataF32=new Float32Array(this.sceneDataBuffer);sceneDataU32=new Uint32Array(this.sceneDataBuffer);renderPipeline;bgPipeline;encoder=new TextEncoder;decoder=new TextDecoder;LOGGING_PREFIX="";constructor(t,n,s,e,i,a,d){this.canvas=t,this.adapter=n,this.device=s,this.context=e,this.engineModule=i,this.renderPipeline=a,this.bgPipeline=d,this.exports=i.instance.exports,this.memory=i.instance.exports.memory,this.LAYOUT_PTR=Number(this.exports.get_memory_layout_ptr()),this.GAME_STATE_PTR=Number(this.getScratchView()[3]),this.inputState=V()}static async create(t,n){return await j(t,n)}destroy(t="unknown reason",n=null){this.resizeObserver.disconnect(),this.destroyed=t,this.destroyedError=n}static async loadTexture(t,n){const e=await(await fetch(n)).blob(),i=await createImageBitmap(e),a=t.createTexture({label:`Texture from  ${n}`,size:[i.width,i.height],format:t.features.has("canvas-rgba16float-support")?"rgba16float":"bgra8unorm",usage:GPUTextureUsage.TEXTURE_BINDING|GPUTextureUsage.COPY_DST|GPUTextureUsage.RENDER_ATTACHMENT});return t.queue.copyExternalImageToTexture({source:i},{texture:a},[i.width,i.height]),a}uploadVisibleChunks(t=1){const n=performance.now();this.exports.prepare_visible_chunks(t,this.canvas.width,this.canvas.height),this.prepare_visible_chunks_time=performance.now()-n}handleVisibleChunks(t){if(this.renderCallId++,!this.currentEncoder||!this.currentTextureView||!this.renderPass)return;const n=this.getScratchPtr();if(this.getScratchLen()===0)return;const e=Number(this.getScratchProperty(0)),i=Number(this.getScratchProperty(1)),a=e*i*2;this.tileMapWidth=e,this.tileMapHeight=i;const d=new Uint32Array(this.memory.buffer,n,a),c=a*4;this.recreateBufferAndBindGroup(c),this.renderPass.setPipeline(this.renderPipeline),this.renderPass.setBindGroup(0,this.bindGroup),this.renderPass.setViewport(0,0,this.canvas.width,this.canvas.height,0,1),this.setSceneData(t,e,i),this.device.queue.writeBuffer(this.tileBuffer,0,d);const h=e*i+1;this.renderPass.draw(6,h),this.isVisibleDataNew=!1}setSceneData(t,n,s){const e=this.getScratchProperty(2,-640),i=this.getScratchProperty(3,-640),a=this.getScratchProperty(4,-640),d=this.getScratchProperty(5,-640),c=this.getScratchProperty(6,-640);this.sceneDataF32[0]=e,this.sceneDataF32[1]=i,this.sceneDataF32[2]=this.canvas.width,this.sceneDataF32[3]=this.canvas.height;const h=6e4,u=(performance.now()-this.startTime)%(h*2);let y;u<h?y=u/1e3:y=(h-(u-h))/1e3,this.sceneDataF32[4]=y,this.sceneDataF32[5]=a,this.sceneDataF32[6]=a<.25?0:this.wireframeOpacity,this.sceneDataF32[7]=t,this.sceneDataF32[8]=d,this.sceneDataF32[9]=c,this.sceneDataU32[10]=n,this.sceneDataU32[11]=s,this.device.queue.writeBuffer(this.uniformBuffer,0,this.sceneDataF32)}recreateBufferAndBindGroup(t){(!this.tileBuffer||this.tileBuffer.size<t)&&(this.tileBuffer=this.device.createBuffer({label:"Tile grid",size:t,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST}),this.bindGroup=this.device.createBindGroup({label:"Tilemap bind group",layout:this.renderPipeline.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:this.uniformBuffer}},{binding:1,resource:{buffer:this.tileBuffer}},{binding:2,resource:this.atlasTextureView},{binding:3,resource:this.pixelSampler}]}))}getWASMMemoryMB(){return this.memory.buffer.byteLength/1024/1024}getGameView(t,n=0,s){return new P[t](this.memory.buffer,this.GAME_STATE_PTR+n,s)}getRawView(t,n,s){return new P[t](this.memory.buffer,n,s)}_tempScratchView=null;getScratchView(){return(this._tempScratchView===null||this._tempScratchView.buffer!==this.memory.buffer)&&(this._tempScratchView=new BigUint64Array(this.memory.buffer,this.LAYOUT_PTR,24)),this._tempScratchView}getScratchPtr(){return Number(this.getScratchView()[0])}getScratchLen(){return Number(this.getScratchView()[1])}setScratchLen(t){this.getScratchView()[1]=BigInt(t)}getScratchCapacity(){return Number(this.getScratchView()[2])}getScratchProperty(t,n=64){(this._tempScratchView===null||this._tempScratchView.buffer!==this.memory.buffer)&&(this._tempScratchView=new BigUint64Array(this.memory.buffer,this.LAYOUT_PTR,24));let s=this._tempScratchView;return n==-640&&(s=new Float64Array(s.buffer,s.byteOffset,s.length)),Number(s[t+4])}readStr(t=this.getScratchPtr(),n=this.getScratchLen()){const s=new Uint8Array(this.memory.buffer,t,n);return this.decoder.decode(s)}writeStr(t,n=!0){const s=t.length;if(s===0)return null;n&&this.setScratchLen(0);const e=this.exports.scratch_alloc(s);if(e===0n)return null;const i=new Uint8Array(this.memory.buffer,Number(e),s);if(this.encoder.encodeInto(t,i).read<s)throw new RangeError("String truncated with non-ASCII characters detected.");return Number(e)}async setSeed(t){this.seed=t,await N(t,this.getGameView(64,A.seed,8))}updateCanvasStyle(){this.forceAspectRatio!==this.previousForceAspectRatio&&(this.previousForceAspectRatio=this.forceAspectRatio,this.forceAspectRatio?(this.canvas.style.maxWidth=`calc(100vh*${16/9})`,this.canvas.style.maxHeight=`calc(100vw*${9/16})`):(this.canvas.style.maxWidth="none",this.canvas.style.maxHeight="none"))}onResize=t=>{const n=t[0];let s,e;if(n.devicePixelContentBoxSize)s=n.devicePixelContentBoxSize[0].inlineSize,e=n.devicePixelContentBoxSize[0].blockSize;else if(n.contentBoxSize){const i=n.contentBoxSize[0].inlineSize,a=n.contentBoxSize[0].blockSize;s=Math.round(i*devicePixelRatio),e=Math.round(a*devicePixelRatio)}else{const i=n.contentRect.width,a=n.contentRect.height;s=Math.round(i*devicePixelRatio),e=Math.round(a*devicePixelRatio)}(this.canvas.width!==s||this.canvas.height!==e)&&(this.canvas.width=s,this.canvas.height=e)};renderFrame(t,n){if(this.renderCallId=0,this.destroyed!==!1)return;this.updateCanvasStyle(),this.currentEncoder=this.device.createCommandEncoder(),this.currentTextureView=this.context.getCurrentTexture().createView();const e=this.currentEncoder.beginRenderPass({colorAttachments:[{view:this.currentTextureView,loadOp:"load",clearValue:{r:0,g:0,b:0,a:1},storeOp:"store"}]});this.renderPass=e,this.recreateBufferAndBindGroup(65536),this.sceneDataF32[7]=1,this.device.queue.writeBuffer(this.uniformBuffer,0,this.sceneDataF32),this.renderPass.setPipeline(this.bgPipeline),this.renderPass.setBindGroup(0,this.bindGroup),this.renderPass.draw(3),this.uploadVisibleChunks(t),this.renderPass.end(),this.device.queue.submit([this.currentEncoder.finish()]),this.currentEncoder=null,this.currentTextureView=null}tick(t){const n=this.getGameView(32,A.keys_pressed_mask,2);H(this.inputState),n[0]=this.inputState.keysPressed,n[1]=this.inputState.keysHeld,this.exports.tick(t)}}location.protocol==="file:"&&alert("This game cannot run from a local file:// context; use an online version or test from localhost instead.");isSecureContext||alert("This game cannot run in a non-secure context.");navigator.gpu||alert("WebGPU is not supported by your browser; try playing this on an alternate or more modern browser.");const Y=await navigator.gpu.requestAdapter();Y||alert("WebGPU is supported, but no compatible GPU was found.");const J=["text1","text2","text3","text4","logicText","renderText"];document.addEventListener("wheel",function(r){r.ctrlKey},{passive:!1});let l=await T.create();l.getTimeoutLength=function(){return++W%3==2?16:17};l.getFrameRate=function(){return 60};l.baseSpeed=1;let m=performance.now(),b=0,W=0;globalThis.engine=l;console.log("Engine initialized successfully:",l),console.log("Exported functions and memory:",l.exports);window.addEventListener("blur",()=>m=1/0);var w=Array(60).fill(0),E=Array(60).fill(0);l.isDebug=!!l.exports.isDebug();l.renderLoop=function(r){let t=performance.now(),n=m===1/0?0:t-m,s=Math.min(n*l.getFrameRate()/1e3,l.getFrameRate());l.logicLoop(Math.floor(b+s)),b=(b+s)%1;let e="#cccccc";if(n>55?e="#e83769":n>30?e="#f39c19":n>20&&(e="#f7ce1a"),l.isDebug){w.shift(),w.push(n),E.shift(),E.push(l.prepare_visible_chunks_time);const a=document.getElementById("renderText");a.textContent=`Time since last render/prepare_visible_chunks time: ${n.toFixed(1)}ms, ${l.prepare_visible_chunks_time.toFixed(1)}ms
Worst (past 60 frames): ${Math.max.apply(null,w).toFixed(1)}ms, ${Math.max.apply(null,E).toFixed(1)}ms`,a.style.fontWeight=n>30?n>55?700:600:500,a.style.color=e}let i=Math.min(b-1,0);l.renderFrame(i,m),requestAnimationFrame(l.renderLoop)};l.logicLoop=function(r){const t=performance.now();for(let e=0;e<r;e++)l.tick(60/l.getFrameRate()*l.baseSpeed);m=performance.now();let n=m-t,s="#cccccc";if(n>30?s="#e83769":n>15?s="#f39c19":n>10&&(s="#f7ce1a"),l.isDebug){const e=document.getElementById("logicText");e.textContent=`Logic diff: ${n.toFixed(1)}ms for ${r} tick${r==1?"":"s"}
`,e.style.fontWeight=n>30?n>55?700:600:500,e.style.color=s}};globalThis.Zig={KeyBits:o,game_state_offsets:A};l.isDebug?(console.log("Zig code is in debug mode. Use engine.exports to see its functions, variables, and memory, such as engine.exports.test_logs."),J.forEach(r=>{document.getElementById(r).style.display="inline"})):console.log('Note: engine is in verbose mode, but Zig code is not in -Doptimize=Debug; run just "zig build" to enable additional testing features and safety checks if possible.');setTimeout(function(){l.renderLoop(0)},17);

(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))i(e);new MutationObserver(e=>{for(const s of e)if(s.type==="childList")for(const o of s.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&i(o)}).observe(document,{childList:!0,subtree:!0});function r(e){const s={};return e.integrity&&(s.integrity=e.integrity),e.referrerPolicy&&(s.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?s.credentials="include":e.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function i(e){if(e.ep)return;e.ep=!0;const s=r(e);fetch(e.href,s)}})();const a={zoom:131072,drop:262144,minus:32768,plus:65536,up:2048,left:4096,down:8192,right:16384,k0:1,k1:2,k2:4,k3:8,k4:16,k5:32,k6:64,k7:128,k8:256,k9:512},S={player_pos:0,last_player_pos:16,player_chunk:32,player_velocity:48,camera_pos:64,last_camera_pos:80,camera_scale:96,camera_scale_change:104,depth:112,player_quadrant:120,frame:124,keys_pressed_mask:128,keys_held_mask:132,seed:144,seed2:208},N="abcdefghijklmnopqrstuvwxyz",b=26n;function C(n=100){if(n<=0)return"";const t=new Uint8Array(72);crypto.getRandomValues(t);let r=0n;const i=new DataView(t.buffer);for(let o=0;o<t.length;o+=8)r=r<<64n|i.getBigUint64(o);let e="",s=r%b**BigInt(n);for(;s>=0n&&(e+=N[Number(s%b)],s=s/b-1n,!(s<0n)););return e}function V(n){let t=0n;for(let r=0;r<n.length;r++){const i=BigInt(n.charCodeAt(r)-97);t=t*b+(i+1n)}return t}async function H(n,t){const r=V(n),i=new DataView(new ArrayBuffer(64));for(let l=0;l<8;l++)i.setBigUint64(l*8,r>>BigInt((7-l)*64)&0xffffffffffffffffn);let e=new Uint8Array(i.buffer,0,32),s=new Uint8Array(i.buffer,32,32);const o=await Promise.all([0,1,2,3].map(l=>crypto.subtle.importKey("raw",new Uint8Array([l]),{name:"HMAC",hash:"SHA-256"},!1,["sign"])));for(const l of o){const d=new Uint8Array(await crypto.subtle.sign("HMAC",l,s)),p=new Uint8Array(32);for(let f=0;f<32;f++)p[f]=e[f]^d[f];e=s,s=p}const u=new Uint8Array(64);return u.set(e,0),u.set(s,32),t.set(new BigUint64Array(u.buffer)),t}const I={Minus:a.minus,Equal:a.plus,KeyZ:a.zoom,KeyQ:a.drop,Space:a.up,ArrowUp:a.up,KeyW:a.up,ArrowLeft:a.left,KeyA:a.left,ArrowDown:a.down,KeyS:a.down,ArrowRight:a.right,KeyD:a.right,Digit0:a.k0,Digit1:a.k1,Digit2:a.k2,Digit3:a.k3,Digit4:a.k4,Digit5:a.k5,Digit6:a.k6,Digit7:a.k7,Digit8:a.k8,Digit9:a.k9};function q(){let n={};const t={heldMask:0,keysHeld:0,keysPressed:0,currentlyHeld:0,horizontalPriority:0,verticalPriority:0,plusMinusPriority:0};function r(){n={},t.horizontalPriority=0,t.verticalPriority=0,t.plusMinusPriority=0,t.currentlyHeld=0,t.heldMask=0,t.keysPressed=0}return window.addEventListener("keydown",i=>{if(i.repeat||i.altKey||i.ctrlKey||i.metaKey||i.shiftKey)return;const e=I[i.code];e&&(t.heldMask|=e,n[e]=(n[e]||0)+1,e&(a.left|a.right)&&(t.horizontalPriority=e),e&(a.up|a.down)&&(t.verticalPriority=e),e&(a.plus|a.minus)&&(t.plusMinusPriority=e))}),window.addEventListener("keyup",i=>{const e=I[i.code];e&&(n[e]=Math.max(0,(n[e]||0)-1),n[e]===0&&(t.heldMask&=~e,e===t.horizontalPriority&&(t.horizontalPriority=t.heldMask&a.left||t.heldMask&a.right||0),e===t.verticalPriority&&(t.verticalPriority=t.heldMask&a.up||t.heldMask&a.down||0),e===t.plusMinusPriority&&(t.plusMinusPriority=t.heldMask&a.plus||t.heldMask&a.minus||0)))}),window.addEventListener("blur",r),document.addEventListener("visibilitychange",r),window.addEventListener("contextmenu",r),t}function W(n){const t=a.up|a.down|a.left|a.right;let r=n.heldMask&~t;r|=n.horizontalPriority,r|=n.verticalPriority,r|=n.plusMinusPriority,n.keysPressed=r&~n.keysHeld,n.currentlyHeld=r,n.keysHeld=r}const K=""+new URL("main-DGIs9K6P.wasm",import.meta.url).href,Z=`/*

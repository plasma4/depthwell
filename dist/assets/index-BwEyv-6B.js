...
`,Q=""+new URL("main-BdprWHTI.png",import.meta.url).href,$="data:image/png;base64,";async function J(i,t){const n=await navigator.gpu.requestAdapter({powerPreference:t&&t.highPerformance?"high-performance":"low-power"});if(!n)throw new DOMException("Couldn't request WebGPU adapter.","NotSupportedError");const r=await n.requestDevice();let e=null;if(r.addEventListener("uncapturederror",f=>{const h=f.error;if(e===null)if(globalThis.reportError)reportError(h);else throw h;else if(!e.destroyed){e.destroy("fatal WebGPU error",h);return}}),r.lost.then(f=>console.error(`WebGPU Device lost: ${f.message}`)),i===void 0){if(i=document.getElementsByTagName("canvas")[0],i===void 0)throw Error("No canvas element or ID string provided, and no canvas was not found in the HTML.")}else if(typeof i=="string"){const f=document.getElementById(i);if(!(f instanceof HTMLCanvasElement))throw Error(`Element with ID "${i}" is not a canvas element.`);i=f}const s=i.getContext("webgpu");if(!s)throw Error("Could not get WebGPU context from canvas.");const o=window.matchMedia("(color-gamut: p3)").matches,l=r.features.has("canvas-rgba16float-support")?"rgba16float":"bgra8unorm";s.configure({device:r,format:l,colorSpace:o&&l==="rgba16float"?"display-p3":"srgb",alphaMode:"opaque"});const u=await WebAssembly.instantiateStreaming(fetch(Y),{env:{js_message:(f,h,x)=>{let m=new TextDecoder().decode(new Uint8Array(p.buffer,Number(f),Number(h)));m.charAt(0)!=="]"?m="["+(e.LOGGING_PREFIX||"")+m:m=m.slice(1),x===1?console.info("%c"+m,"font-weight: 600"):[console.log,console.info,console.warn,console.error][x](m)},js_write_text:(f,h,x)=>{const m=new Uint8Array(p.buffer,Number(h),Number(x)),C=new TextDecoder().decode(m),V=document.getElementById(`text${f+1}`);V.textContent=C},js_get_time:()=>performance.now(),js_handle_visible_chunks:f=>e.handleVisibleChunks(f),js_handle_visible_entities:()=>e.handleVisibleEntities(),js_set_mouse_type:f=>e.setMouseType(f)}}),d=u.instance.exports,p=d.memory,_=r.createShaderModule({label:"Main shader",code:j.replace("/* TILES_PER_ROW */ 1 /* TILES_PER_ROW */",""+d.get_tiles_per_row()).replace("/* TILES_PER_COLUMN */ 1 /* TILES_PER_COLUMN */",""+d.get_tiles_per_column()).replace("/* STONE_START */ 1 /* STONE_START */",""+d.get_stone_start()).replace("/* ORE_START */ 1 /* ORE_START */",""+d.get_ore_start()).replace("/* GEM_START */ 1 /* GEM_START */",""+d.get_gem_start()).replace("/* GEM_MASK_START */ 1 /* GEM_MASK_START */",""+d.get_gem_mask_start()).replace("/* DECOR_START */ 1 /* DECOR_START */",""+d.get_decor_start())}),v=r.createBindGroupLayout({label:"Main bind group layout",entries:[{binding:0,visibility:GPUShaderStage.VERTEX|GPUShaderStage.FRAGMENT,buffer:{type:"uniform",hasDynamicOffset:!0}},{binding:1,visibility:GPUShaderStage.VERTEX|GPUShaderStage.FRAGMENT,buffer:{type:"read-only-storage"}},{binding:2,visibility:GPUShaderStage.FRAGMENT,texture:{}},{binding:3,visibility:GPUShaderStage.FRAGMENT,texture:{}},{binding:4,visibility:GPUShaderStage.FRAGMENT,sampler:{}},{binding:5,visibility:GPUShaderStage.VERTEX|GPUShaderStage.FRAGMENT,buffer:{type:"read-only-storage"}}]}),w=r.createPipelineLayout({label:"Shared Pipeline Layout",bindGroupLayouts:[v]}),O=r.createRenderPipeline({label:"Tilemap pipeline",layout:w,vertex:{module:_,entryPoint:"vs_tile"},fragment:{module:_,entryPoint:"fs_main",targets:[{format:l,blend:{color:{srcFactor:"src-alpha",dstFactor:"one-minus-src-alpha"},alpha:{srcFactor:"one",dstFactor:"one-minus-src-alpha"}}}]},primitive:{topology:"triangle-list",cullMode:"none"}}),M=r.createRenderPipeline({label:"Background pipeline",layout:w,vertex:{module:_,entryPoint:"vs_background"},fragment:{module:_,entryPoint:"fs_background",targets:[{format:l}]},primitive:{topology:"triangle-list"}}),G=r.createRenderPipeline({label:"Entity pipeline",layout:w,vertex:{module:_,entryPoint:"vs_entity"},fragment:{module:_,entryPoint:"fs_entity",targets:[{format:l,blend:{color:{srcFactor:"src-alpha",dstFactor:"one-minus-src-alpha"},alpha:{srcFactor:"one",dstFactor:"one-minus-src-alpha"}}}]},primitive:{topology:"triangle-list"}});e=new E(i,n,r,s,u,O,M,G),e.exports.setup(),await e.setSeed(q(100)),e.startDelta=Number(d.mix_seed(60n)%120000n),e.exports.init();const D=new ResizeObserver(e.onResize);e.resizeObserver=D,e.updateCanvasStyle();try{e.resizeObserver.observe(i,{box:"device-pixel-content-box"})}catch{console.log("ResizeObserver property device-pixel-content-box not supported, falling back to content-box."),e.resizeObserver.observe(i,{box:"content-box"})}e.onResize([{contentRect:{width:i.clientWidth,height:i.clientHeight}}]);const F=await E.loadTexture(r,Q),z=await E.loadTexture(r,$),N=r.createSampler({magFilter:"nearest",minFilter:"nearest",addressModeU:"clamp-to-edge",addressModeV:"clamp-to-edge"});return e.atlasTextureView=F.createView(),e.atlasTextureMaskView=z.createView(),e.pixelSampler=N,e.uniformBuffer=r.createBuffer({label:"SceneUniforms",size:256*b,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),e.entityBuffer=e.device.createBuffer({label:"Entities",size:2400,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST}),e.isP3=o&&l==="rgba16float",e.is8Bit=l==="bgra8unorm",e.gamutMediaQuery=window.matchMedia("(color-gamut: p3)"),e.gamutMediaQuery.addEventListener("change",f=>{const h=f.matches&&l==="rgba16float";h!==e.isP3&&(e.isP3=h,s.configure({device:r,format:l,colorSpace:h?"display-p3":"srgb",alphaMode:"opaque"}))}),e}var U=(i=>(i[i.Uint8=8]="Uint8",i[i.Uint16=16]="Uint16",i[i.Uint32=32]="Uint32",i[i.Uint64=64]="Uint64",i[i.Int8=-8]="Int8",i[i.Int16=-16]="Int16",i[i.Int32=-32]="Int32",i[i.Int64=-64]="Int64",i[i.Uint8Clamped=-80]="Uint8Clamped",i[i.Float32=-320]="Float32",i[i.Float64=-640]="Float64",i))(U||{});globalThis.WasmTypeCode=U;const L={8:Uint8Array,16:Uint16Array,32:Uint32Array,64:BigUint64Array,[-8]:Int8Array,[-16]:Int16Array,[-32]:Int32Array,[-64]:BigInt64Array,[-80]:Uint8ClampedArray,[-320]:Float32Array,[-640]:Float64Array},b=4;class E{engineModule;exports;memory;LAYOUT_PTR;GAME_STATE_PTR;mouseType;canvas;adapter;device;context;bindGroups=Array(b);uniformBuffer;tileBuffers=Array(b);entityBuffer;tileBufferDirty=!1;atlasTextureView;atlasTextureMaskView;pixelSampler;tilePipeline;bgPipeline;entityPipeline;renderPass=null;currentEncoder=null;currentTextureView=null;renderCallId=0;sceneDataBuffer=new ArrayBuffer(256);sceneDataF32=new Float32Array(this.sceneDataBuffer);sceneDataU32=new Uint32Array(this.sceneDataBuffer);inputState;resizeObserver;forceAspectRatio=!0;previousForceAspectRatio=null;tileMapWidth;tileMapHeight;last_upload_visible_chunks_time=0;prepare_visible_data_time=0;isVisibleDataNew=!0;wireframeOpacity=0;startTime=performance.now();startDelta;seed="";destroyed=!1;destroyedError=null;encoder=new TextEncoder;decoder=new TextDecoder;isP3=!1;is8Bit=!1;gamutMediaQuery=null;LOGGING_PREFIX="";constructor(t,n,r,e,s,o,l,u){this.canvas=t,this.adapter=n,this.device=r,this.context=e,this.engineModule=s,this.tilePipeline=o,this.bgPipeline=l,this.entityPipeline=u,this.exports=s.instance.exports,this.memory=s.instance.exports.memory,this.LAYOUT_PTR=Number(this.exports.get_memory_layout_ptr()),this.GAME_STATE_PTR=Number(this.getScratchView()[3]),this.inputState=X()}static async create(t,n){return await J(t,n)}destroy(t="unknown reason",n=null){this.resizeObserver.disconnect(),this.destroyed=t,this.destroyedError=n}static async loadTexture(t,n){const e=await(await fetch(n)).blob(),s=await createImageBitmap(e),o=t.createTexture({label:`Texture from ${n}`,size:[s.width,s.height],format:t.features.has("canvas-rgba16float-support")?"rgba16float":"bgra8unorm",usage:GPUTextureUsage.TEXTURE_BINDING|GPUTextureUsage.COPY_DST|GPUTextureUsage.RENDER_ATTACHMENT});return t.queue.copyExternalImageToTexture({source:s},{texture:o},[s.width,s.height]),o}uploadVisibleChunks(t=1){const n=performance.now();this.exports.prepare_visible_data(t,n-this.last_upload_visible_chunks_time,this.canvas.width,this.canvas.height),this.last_upload_visible_chunks_time=n,this.prepare_visible_data_time=performance.now()-n}handleVisibleChunks(t){if(!this.currentEncoder||!this.currentTextureView||!this.renderPass)return;const n=this.getScratchPtr();if(this.getScratchLen()===0)return;const e=Number(this.getScratchProperty(0)),s=Number(this.getScratchProperty(1)),o=e*s*2;this.tileMapWidth=e,this.tileMapHeight=s;const l=new Uint32Array(this.memory.buffer,n,o);this.recreateBufferAndBindGroup(o*4),this.renderPass.setPipeline(this.tilePipeline),this.renderPass.setBindGroup(0,this.bindGroups[this.renderCallId],[this.renderCallId*256]),this.renderPass.setViewport(0,0,this.canvas.width,this.canvas.height,0,1),this.setSceneData(t,e,s),this.device.queue.writeBuffer(this.tileBuffers[this.renderCallId],0,l);const u=e*s+1;this.renderPass.draw(6,u),this.renderCallId++}handleVisibleEntities(){this.renderCallId=0;const t=this.getScratchPtr(),n=this.getScratchProperty(0)*48;if(n===0||!this.renderPass)return;this.entityBuffer.size<n&&(this.entityBuffer=this.device.createBuffer({label:"Entities",size:n,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST}),this.recreateBufferAndBindGroup(0));const r=new Uint8Array(this.memory.buffer,t,n);this.device.queue.writeBuffer(this.entityBuffer,0,r),this.renderPass.setPipeline(this.entityPipeline),this.renderPass.setBindGroup(0,this.bindGroups[0],[0]),this.renderPass.draw(8,n/48)}setMouseType(t){t==0?this.mouseType!=0&&(this.canvas.style.cursor=null):t==1&&this.mouseType!=0&&(this.canvas.style.cursor="pointer"),this.mouseType=t}setSceneData(t,n,r){const e=this.getScratchProperty(2,-640),s=this.getScratchProperty(3,-640),o=this.getScratchProperty(4,-640),l=this.getScratchProperty(5,-640),u=this.getScratchProperty(6,-640);this.sceneDataF32[0]=e,this.sceneDataF32[1]=s,this.sceneDataF32[2]=this.canvas.width,this.sceneDataF32[3]=this.canvas.height;const d=12e4,_=(performance.now()-this.startTime+this.startDelta)%(d*2);let v;_<d?v=_/1e3:v=(d-(_-d))/1e3,this.sceneDataF32[4]=v,this.sceneDataF32[5]=o,this.sceneDataF32[6]=o<.25?0:this.wireframeOpacity,this.sceneDataF32[7]=t,this.sceneDataF32[8]=l,this.sceneDataF32[9]=u,this.sceneDataU32[10]=n,this.sceneDataU32[11]=r,this.sceneDataU32[12]=this.isP3?1:0,this.sceneDataU32[13]=this.is8Bit?1:0,this.device.queue.writeBuffer(this.uniformBuffer,this.renderCallId*256,this.sceneDataF32)}recreateBufferAndBindGroup(t){const n=this.renderCallId;(t===0||!this.tileBuffers[n]||this.tileBuffers[n].size<t)&&(this.tileBuffers[n]=this.device.createBuffer({label:`Tile grid slot ${n}`,size:Math.max(t,256*b),usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST}),this.bindGroups[n]=this.device.createBindGroup({label:`Bind group slot ${n}`,layout:this.tilePipeline.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:this.uniformBuffer,offset:0,size:256}},{binding:1,resource:{buffer:this.tileBuffers[n]}},{binding:2,resource:this.atlasTextureView},{binding:3,resource:this.atlasTextureMaskView},{binding:4,resource:this.pixelSampler},{binding:5,resource:{buffer:this.entityBuffer}}]}))}getWASMMemoryMB(){return this.memory.buffer.byteLength/1024/1024}getGameView(t,n=0,r){return new L[t](this.memory.buffer,this.GAME_STATE_PTR+n,r)}getRawView(t,n,r){return new L[t](this.memory.buffer,n,r)}_tempScratchViewU64=null;_tempScratchViewF64=null;getScratchView(){return(this._tempScratchViewU64===null||this._tempScratchViewU64.buffer!==this.memory.buffer)&&(this._tempScratchViewU64=new BigUint64Array(this.memory.buffer,this.LAYOUT_PTR,24)),this._tempScratchViewU64}getScratchPtr(){return Number(this.getScratchView()[0])}getScratchLen(){return Number(this.getScratchView()[1])}setScratchLen(t){this.getScratchView()[1]=BigInt(t)}getScratchCapacity(){return Number(this.getScratchView()[2])}getScratchProperty(t,n=64){(this._tempScratchViewU64===null||this._tempScratchViewU64.buffer!==this.memory.buffer)&&(this._tempScratchViewU64=new BigUint64Array(this.memory.buffer,this.LAYOUT_PTR,24));let r=this._tempScratchViewU64;return n==-640&&((this._tempScratchViewF64===null||this._tempScratchViewF64.buffer!==this.memory.buffer)&&(this._tempScratchViewF64=new Float64Array(r.buffer,r.byteOffset,r.length)),r=this._tempScratchViewF64),Number(r[t+4])}readStr(t=this.getScratchPtr(),n=this.getScratchLen()){const r=new Uint8Array(this.memory.buffer,t,n);return this.decoder.decode(r)}writeStr(t,n=!0){const r=t.length;if(r===0)return null;n&&this.setScratchLen(0);const e=this.exports.scratch_alloc(r);if(e===0n)return null;const s=new Uint8Array(this.memory.buffer,Number(e),r);if(this.encoder.encodeInto(t,s).read<r)throw new RangeError("String truncated with non-ASCII characters detected.");return Number(e)}async setSeed(t){this.seed=t,await K(t,this.getGameView(64,k.seed,8))}updateCanvasStyle(){this.forceAspectRatio!==this.previousForceAspectRatio&&(this.previousForceAspectRatio=this.forceAspectRatio,this.forceAspectRatio?(this.canvas.style.maxWidth=`calc(100vh*${16/9})`,this.canvas.style.maxHeight=`calc(100vw*${9/16})`):(this.canvas.style.maxWidth="none",this.canvas.style.maxHeight="none"))}onResize=t=>{const n=t[0];let r,e;if(n.devicePixelContentBoxSize)r=n.devicePixelContentBoxSize[0].inlineSize,e=n.devicePixelContentBoxSize[0].blockSize;else if(n.contentBoxSize){const s=n.contentBoxSize[0].inlineSize,o=n.contentBoxSize[0].blockSize;r=Math.round(s*devicePixelRatio),e=Math.round(o*devicePixelRatio)}else{const s=n.contentRect.width,o=n.contentRect.height;r=Math.round(s*devicePixelRatio),e=Math.round(o*devicePixelRatio)}(this.canvas.width!==r||this.canvas.height!==e)&&(this.canvas.width=r,this.canvas.height=e)};renderFrame(t,n){if(this.renderCallId=0,this.destroyed!==!1)return;this.updateCanvasStyle(),this.currentEncoder=this.device.createCommandEncoder(),this.currentTextureView=this.context.getCurrentTexture().createView();const r=this.currentEncoder.beginRenderPass({colorAttachments:[{view:this.currentTextureView,loadOp:"clear",clearValue:{r:0,g:0,b:0,a:1},storeOp:"store"}]});this.renderPass=r,this.recreateBufferAndBindGroup(256*b),this.sceneDataF32[7]=1,this.sceneDataU32[12]=this.isP3?1:0,this.sceneDataU32[13]=this.is8Bit?1:0,this.device.queue.writeBuffer(this.uniformBuffer,this.renderCallId*256,this.sceneDataF32),this.renderPass.setPipeline(this.bgPipeline),this.renderPass.setBindGroup(0,this.bindGroups[this.renderCallId],[this.renderCallId++*256]),this.renderPass.draw(3),this.uploadVisibleChunks(t),this.renderPass.end(),this.device.queue.submit([this.currentEncoder.finish()]),this.currentEncoder=null,this.currentTextureView=null}tick(t,n){const r=this.getGameView(32,k.keys_pressed_mask,2);Z(this.inputState),r[0]=this.inputState.keysPressed,r[1]=this.inputState.keysHeld,this.exports.tick(t,n)}}location.protocol==="file:"&&alert("This game cannot run from a local file:// context; use an online version or test from localhost instead.");isSecureContext||alert("This game cannot run in a non-secure context.");navigator.gpu||alert("WebGPU is not supported by your browser; try playing this on an alternate or more modern browser.");const ee=await navigator.gpu.requestAdapter();ee||alert("WebGPU is supported, but no compatible GPU was found.");globalThis.Zig={KeyBits:a,game_state_offsets:k};console.log("Zig code is in debug mode. Use engine.exports to see its functions, variables, and memory, such as engine.exports.test_logs."),document.body.innerHTML+=`
    ...
    <div id="debugContainer"></div>`;document.addEventListener("wheel",function(i){i.ctrlKey},{passive:!1});let c=await E.create();c.getTimeoutLength=function(){return++te%3==2?16:17};c.getFrameRate=function(){return 60};c.baseSpeed=1;let g=performance.now(),y=0,te=0;globalThis.engine=c;console.log("Engine initialized successfully:",c),console.log("Exported functions and memory:",c.exports);const S=Array(60).fill(0),R=Array(60).fill(0),P=Array(60).fill(0);c.isDebug=!!c.exports.isDebug();c.renderLoop=function(i){let t=performance.now(),n=g===1/0?0:t-g;g=t;const r=1e3/c.getFrameRate(),e=n/r,s=y+e;let o=Math.floor(s);o>5&&(o=5),o>0?(c.logicLoop(o),y=s-o):y=s;{R.shift(),R.push(n),P.shift(),P.push(c.prepare_visible_data_time);const u=Math.max.apply(null,R),d=Math.max.apply(null,P);let p="#cccccc";u>55?p="#e83769":u>30?p="#f39c19":u>20&&(p="#f7ce1a");const _=document.getElementById("renderText");_.textContent=`Time since last render/prepare_visible_data time: ${n.toFixed(1)}ms, ${c.prepare_visible_data_time.toFixed(1)}ms
Worst (past 60 frames): ${u.toFixed(1)}ms, ${d.toFixed(1)}ms`,_.style.fontWeight=u>40?u>55?700:600:500,_.style.color=p}let l=Math.min(y-1,0);c.renderFrame(l,g),requestAnimationFrame(c.renderLoop)};c.logicLoop=function(i){const t=performance.now(),n=60/c.getFrameRate()*c.baseSpeed;c.tick(n,i),g=performance.now();let r=g-t;{S.shift(),S.push(r);const e=Math.max.apply(null,S);let s="#cccccc";e>30?s="#e83769":e>15?s="#f39c19":e>10&&(s="#f7ce1a");const o=document.getElementById("logicText");o.textContent=`Logic diff: ${r.toFixed(1)}ms for ${i} tick${i==1?"":"s"}
Worst (past 60 frames): ${e.toFixed(1)}ms
`,o.style.fontWeight=e>20?e>40?700:600:500,o.style.color=s}};const T=(i,t)=>{const n=c.canvas.getBoundingClientRect();if(i==null){c.exports.handle_mouse(-1,-1,5);return}const r=(i.clientX-n.left)/n.width,e=(i.clientY-n.top)/n.height;r>=0&&r<=1&&e>=0&&e<=1?c.exports.handle_mouse(r,e,t):c.exports.handle_mouse(-1,-1,t)};window.addEventListener("blur",()=>{g=1/0,T(null,0)});document.addEventListener("pointermove",i=>{T(i,0)});document.addEventListener("pointerdown",i=>{const t=i.target;if(!t||document.getElementById("debugContainer").contains(t))return;const n=i.button===2?3:1;T(i,n)});document.addEventListener("pointerup",i=>{const t=i.button===2?4:2;T(i,t)});c.canvas.style.touchAction="none";document.addEventListener("contextmenu",i=>i.preventDefault());{const i=c.exports;i.debug_build_ui_metadata();const t=c.readStr(),n=JSON.parse(t),r=document.getElementById("debugContainer");n.buttons.forEach(e=>{const s=document.createElement("button");s.textContent=e.name,s.onclick=()=>i.debug_ui_button_click(e.id),r.appendChild(s)}),n.sliders.forEach(e=>{const s=document.createElement("div");s.style.display="flex",s.style.flexDirection="column";const o=document.createElement("label");o.textContent=`${e.name}: ${e.val.toFixed(2)}`,o.style.fontSize="12px";const l=document.createElement("input");l.type="range",l.min=e.min,l.max=e.max,l.step=((e.max-e.min)/1e3).toString(),l.value=e.val,l.oninput=u=>{const d=parseFloat(u.target.value);o.textContent=`${e.name}: ${d.toFixed(2)}`,i.debug_ui_slider_change(e.id,d)},s.appendChild(o),s.appendChild(l),r.appendChild(s)}),document.body.appendChild(r)}setTimeout(function(){c.renderLoop(0)},17);

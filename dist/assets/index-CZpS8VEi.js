(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))i(t);new MutationObserver(t=>{for(const s of t)if(s.type==="childList")for(const a of s.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&i(a)}).observe(document,{childList:!0,subtree:!0});function n(t){const s={};return t.integrity&&(s.integrity=t.integrity),t.referrerPolicy&&(s.referrerPolicy=t.referrerPolicy),t.crossOrigin==="use-credentials"?s.credentials="include":t.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function i(t){if(t.ep)return;t.ep=!0;const s=n(t);fetch(t.href,s)}})();const o={zoom:131072,mine:262144,inventory_up:524288,inventory_down:1048576,minus:32768,plus:65536,up:2048,left:4096,down:8192,right:16384,k0:1,k1:2,k2:4,k3:8,k4:16,k5:32,k6:64,k7:128,k8:256,k9:512},P={player_pos:0,last_player_pos:16,player_chunk:32,player_velocity:48,camera_pos:64,last_camera_pos:80,camera_scale:96,camera_scale_change:104,depth:112,player_quadrant:120,frame:124,keys_pressed_mask:128,keys_held_mask:132,seed:144,seed2:208},V="abcdefghijklmnopqrstuvwxyz",E=26n;function q(r=100){if(r<=0)return"";const e=new Uint8Array(72);crypto.getRandomValues(e);let n=0n;const i=new DataView(e.buffer);for(let a=0;a<e.length;a+=8)n=n<<64n|i.getBigUint64(a);let t="",s=n%E**BigInt(r);for(;s>=0n&&(t+=V[Number(s%E)],s=s/E-1n,!(s<0n)););return t}function Z(r){let e=0n;for(let n=0;n<r.length;n++){const i=BigInt(r.charCodeAt(n)-97);e=e*E+(i+1n)}return e}async function K(r,e){const n=Z(r),i=new DataView(new ArrayBuffer(64));for(let c=0;c<8;c++)i.setBigUint64(c*8,n>>BigInt((7-c)*64)&0xffffffffffffffffn);let t=new Uint8Array(i.buffer,0,32),s=new Uint8Array(i.buffer,32,32);const a=await Promise.all([0,1,2,3].map(c=>crypto.subtle.importKey("raw",new Uint8Array([c]),{name:"HMAC",hash:"SHA-256"},!1,["sign"])));for(const c of a){const f=new Uint8Array(await crypto.subtle.sign("HMAC",c,s)),p=new Uint8Array(32);for(let d=0;d<32;d++)p[d]=t[d]^f[d];t=s,s=p}const l=new Uint8Array(64);return l.set(t,0),l.set(s,32),e.set(new BigUint64Array(l.buffer)),e}const k={Minus:o.minus,Equal:o.plus,KeyZ:o.zoom,Backquote:o.mine,KeyQ:o.inventory_up,KeyE:o.inventory_down,Space:o.up,ArrowUp:o.up,KeyW:o.up,ArrowLeft:o.left,KeyA:o.left,ArrowDown:o.down,KeyS:o.down,ArrowRight:o.right,KeyD:o.right,Digit0:o.k0,Digit1:o.k1,Digit2:o.k2,Digit3:o.k3,Digit4:o.k4,Digit5:o.k5,Digit6:o.k6,Digit7:o.k7,Digit8:o.k8,Digit9:o.k9},G=o.up|o.down|o.left|o.right;function W(){let r={};const e={heldMask:0,keysHeld:0,keysPressed:0,currentlyHeld:0,horizontalPriority:0,verticalPriority:0,plusMinusPriority:0};function n(){r={},e.horizontalPriority=0,e.verticalPriority=0,e.plusMinusPriority=0,e.currentlyHeld=0,e.heldMask=0,e.keysPressed=0}return window.addEventListener("keydown",i=>{if(i.repeat)return;if(i.ctrlKey||i.metaKey){n();return}const t=k[i.code];t&&(t<=512&&(e.heldMask=e.heldMask&4294966272),e.heldMask|=t,t&G&&(r[t]=(r[t]||0)+1),t&(o.left|o.right)&&(e.horizontalPriority=t),t&(o.up|o.down)&&(e.verticalPriority=t),t&(o.plus|o.minus)&&(e.plusMinusPriority=t))}),window.addEventListener("keyup",i=>{const t=k[i.code];t&&(t&G?(r[t]=Math.max(0,(r[t]||0)-1),r[t]===0&&(e.heldMask&=~t)):e.heldMask&=~t,e.heldMask&t||(t===e.horizontalPriority&&(e.horizontalPriority=e.heldMask&o.left||e.heldMask&o.right||0),t===e.verticalPriority&&(e.verticalPriority=e.heldMask&o.up||e.heldMask&o.down||0),t===e.plusMinusPriority&&(e.plusMinusPriority=e.heldMask&o.plus||e.heldMask&o.minus||0)))}),window.addEventListener("blur",n),document.addEventListener("visibilitychange",n),window.addEventListener("contextmenu",n),e}function Y(r){const e=o.up|o.down|o.left|o.right;let n=r.heldMask&~e;n|=r.horizontalPriority,n|=r.verticalPriority,n|=r.plusMinusPriority,r.keysPressed=n&~r.keysHeld,r.currentlyHeld=n,r.keysHeld=n}const j=""+new URL("main-RHDwfPWC.wasm",import.meta.url).href,X=`/*

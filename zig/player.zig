...
const friction: @Vector(2, f64) = .{ 0.75, 0.75 };
const inv_friction: @Vector(2, f64) = .{ 0.25, 0.25 };
const pixel_mult: @Vector(2, f64) = .{ 16.0, 16.0 };
...
pub fn move() void {
    ...
    game.player_velocity = game.player_velocity * friction + input_dir * inv_friction;
    ...
    logger.quick(.{ game.player_velocity, game.camera_pos });
}
